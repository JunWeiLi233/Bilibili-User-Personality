...
from python_backend.scrapers.uid_pipeline import UidPipelineStateContractComparator as UidPipelineStatePayloadComparator, UidPipelineStateReporter, UidPipelineStateSummary
...
class UidPipelineStateContractComparator:
    ...
    def __init__(self, data_dir: str | Path, js_report_path: str | Path):
        ...
        self.comparator = UidPipelineStatePayloadComparator(self.summary)
