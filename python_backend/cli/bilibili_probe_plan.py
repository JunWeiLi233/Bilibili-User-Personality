...
from python_backend.scrapers.bilibili_probe import BilibiliProbePlanPayloadContractComparator as BilibiliProbePlanContractComparator, BilibiliProbePlanRunner
...
class BilibiliProbePlanCliRunner:
    ...
    def run(self) -> dict:
        ...
        if args.compare_js_report:
            return BilibiliProbePlanContractComparator(args.payload, args.compare_js_report).compare()
        return BilibiliProbePlanRunner(args.payload).run()
