...
from python_backend.analysis.audit import CoverageAuditArtifactWriter, CoverageAuditArtifactsContractComparator as CoverageAuditArtifactsPayloadComparator, CoverageAuditArtifactsSummary
...
class CoverageAuditArtifactsContractComparator:
    ...
    def __init__(self, payload_path: str | Path, js_report_path: str | Path):
        ...
        self.comparator = CoverageAuditArtifactsPayloadComparator(self.summary)
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.compare_js_report:
        result = CoverageAuditArtifactsContractComparator(args.payload, args.compare_js_report).compare()
    else:
        result = CoverageAuditArtifactsRunner(args.payload).run()
