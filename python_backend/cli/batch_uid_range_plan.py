...
from python_backend.scrapers.batch_uid_range import BatchUidRangePlanPayloadContractComparator as BatchUidRangePlanContractComparator, BatchUidRangePlanRequest, BatchUidRangePlanRunner
...
class BatchUidRangePlanCliRunner:
    ...
    def run(self) -> dict:
        ...
        return BatchUidRangePlanRequest(args.payload, compare_js_report_path=args.compare_js_report).run()
