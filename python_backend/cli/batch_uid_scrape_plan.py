...
from python_backend.scrapers.batch_uid_scrape import BatchUidScrapePlanContractComparator as BatchUidScrapePlanPayloadComparator, BatchUidScrapePlanSummary, BatchUidScrapePlanner
...
class BatchUidScrapePlanContractComparator:
    ...
    def __init__(self, payload_path: str | Path, js_report_path: str | Path):
        ...
        self.comparator = BatchUidScrapePlanPayloadComparator(self.summary)
