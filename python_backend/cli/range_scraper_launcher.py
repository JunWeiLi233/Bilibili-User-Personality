...
from python_backend.scrapers.batch_uid_range import RangeScraperLauncherPlanner, RangeScraperLauncherSummary
...
class RangeScraperLauncherContractComparator:
    ...
    def compare(self) -> dict[str, Any]:
        python_result = self.summary.summarize(RangeScraperLauncherPlanRunner(self.data_dir).run())
