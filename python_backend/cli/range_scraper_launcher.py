...
from python_backend.scrapers.batch_uid_range import RangeScraperLauncherPlanner
...
class RangeScraperLauncherContractComparator:
    ...
    def compare(self) -> dict[str, Any]:
        python_result = self._contract_summary(RangeScraperLauncherPlanRunner(self.data_dir).run())
