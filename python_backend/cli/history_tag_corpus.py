...
from python_backend.corpus.history_tags import (
    HistoryTagCorpusContractComparator as HistoryTagCorpusPayloadComparator,
    HistoryTagCorpusManager,
    HistoryTagCorpusSummary,
    HistoryTagScrapePlanner,
    HistoryTagScrapePlanContractComparator as HistoryTagScrapePlanPayloadComparator,
    HistoryTagScrapePlanSummary,
)
...
class HistoryTagCorpusContractComparator:
    ...
    def __init__(
        ...
        self.comparator = HistoryTagCorpusPayloadComparator(self.summary)
...
class HistoryTagScrapePlanContractComparator:
    ...
    def __init__(self, payload_path: str | Path, js_report_path: str | Path):
        ...
        self.comparator = HistoryTagScrapePlanPayloadComparator(self.summary)
