...
class TiebaHtmlParseCliRunner:
    ...
    def run(self) -> dict:
        ...
        if args.compare_js_report:
            return TiebaHtmlParseContractComparator(args.payload, args.compare_js_report).compare()
        return TiebaHtmlParseRunner(args.payload).run()
