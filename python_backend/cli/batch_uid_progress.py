...
from python_backend.scrapers.batch_uid_scrape import BatchUidProgressContractComparator as BatchUidProgressPayloadComparator, BatchUidProgressReporter, BatchUidProgressSummary
...
class BatchUidProgressContractComparator:
    ...
    def __init__(self, progress_path: str | Path, js_report_path: str | Path):
        ...
        self.comparator = BatchUidProgressPayloadComparator(self.summary)
