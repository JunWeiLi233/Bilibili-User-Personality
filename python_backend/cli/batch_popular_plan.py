...
class BatchPopularPlanContractComparator:
    ...
    def __init__(self, payload_path: str | Path, js_report_path: str | Path):
        ...
        self.comparator = BatchPopularPlanPayloadComparator(self.summary)
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.compare_js_report:
        result = BatchPopularPlanContractComparator(args.payload, args.compare_js_report).compare()
    else:
        result = BatchPopularPlanRunner(args.payload).run()
