...
class BatchPopularPlanCommandRequest:
    """Argv-backed scraper-layer request for batch popular plan contracts."""
    ...
    def run(self) -> dict[str, Any]:
        ...
        return BatchPopularPlanRequest(args.payload, compare_js_report_path=args.compare_js_report or None).run()
