...
class HarvestOptionsContractComparator:
    """Compare harvest option outputs using the JS/Python JSON contract."""

    def __init__(self, summary: HarvestOptionsSummary | None = None):
        self.summary = summary or HarvestOptionsSummary()
...
class HarvestOptionsPayloadContractComparator:
    ...
    def __init__(self, payload_path: str | Path, js_report_path: str | Path):
        ...
        self.comparator = HarvestOptionsContractComparator(self.summary)
...
class HarvestOptionsRequest:
    """Analysis-layer request object for harvest options JSON contract modes."""
    ...
    def run(self) -> dict[str, Any]:
        if self.compare_js_report_path:
            return HarvestOptionsPayloadContractComparator(
                self.payload_path,
