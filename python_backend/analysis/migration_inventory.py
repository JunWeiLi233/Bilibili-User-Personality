...
DEFAULT_PACKAGE_VALIDATION_SCOPES = {
    ...
    "python:deepseek-analyze-command-compare": "full_command_identity_fields_file_payload_input_python_runtime_mock_multiagent_env_bridge_and_live_gate_contract",
    ...
    "python:coverage-loop-command-compare": "no_live_mock_cycle_no_progress_multi_cycle_report_write_file_backed_mock_harvest_external_options_deepseek_runtime_discovery_options_advanced_harvest_controls_js_adapter_live_bridge_no_progress_no_queries_crash_report_external_prune_commands_deferred_live_contract",
...
class BackendMigrationInventoryScanner:
    ...
    def _replacement_blockers(*, script: str, validation_scope: str, ready_to_replace: bool) -> list[dict[str, str]]:
        ...
        elif script == "deepseek:analyze" and validation_scope == "full_command_identity_fields_file_payload_input_python_runtime_mock_multiagent_env_bridge_and_live_gate_contract":
            blockers.append(
                {
