...
DEFAULT_PACKAGE_VALIDATION_SCOPES = {
    ...
    "python:coverage-loop-command-compare": "no_live_mock_cycle_no_progress_multi_cycle_report_write_file_backed_mock_harvest_external_options_deepseek_runtime_discovery_options_advanced_harvest_controls_source_gap_retry_controls_js_adapter_live_bridge_cli_flag_bridge_no_progress_no_queries_crash_report_external_prune_commands_deferred_live_contract",
    ...
    "python:tieba-keyword-compare": "dry_run_plan_fixture_scrape_fixture_explicit_thread_fixture_provided_threads_fixture_python_scrape_fixture_bridge_and_js_python_plan_bridge",
...
class BackendMigrationInventoryScanner:
    ...
    def _replacement_blockers(*, script: str, validation_scope: str, ready_to_replace: bool) -> list[dict[str, str]]:
        ...
        if script == "dictionary:probe-bilibili" and validation_scope == "dry_run_plan_and_no_live_command_fixture":
            ...
            "no_live_mock_cycle_no_progress_multi_cycle_report_write_file_backed_mock_harvest_external_options_deepseek_runtime_discovery_options_advanced_harvest_controls_source_gap_retry_controls_js_adapter_live_bridge_cli_flag_bridge_no_progress_no_queries_crash_report_external_prune_commands_deferred_live_contract",
        }:
            blockers.append(
                {
