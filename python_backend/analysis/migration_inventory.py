...
DEFAULT_PACKAGE_VALIDATION_SCOPES = {
    ...
    "python:coverage-loop-command-compare": "no_live_mock_cycle_no_progress_multi_cycle_report_write_file_backed_mock_harvest_external_options_js_adapter_live_bridge_no_progress_commands_deferred_live_contract",
