...
class CoverageProgressContractComparator:
    """Compare coverage-progress payloads using the JS/Python summary contract."""

    def __init__(self, summary: CoverageProgressSummary | None = None):
        self.summary = summary or CoverageProgressSummary()
...
class CoverageProgressPayloadContractComparator:
    ...
    def __init__(self, payload_path: str | Path, js_report_path: str | Path):
        ...
        self.comparator = CoverageProgressContractComparator(self.summary)
...
class CoverageProgressRequest:
    """Analysis-layer request object for coverage-progress JSON contract modes."""
    ...
    def run(self) -> dict[str, Any]:
        if self.compare_js_report_path:
            return CoverageProgressPayloadContractComparator(
                self.payload_path,
