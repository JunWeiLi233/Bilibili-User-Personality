...
import { buildDictionaryCoverageAudit, DEFAULT_HARVEST_STATE_PATH, readKeywordHarvestState } from '../services/keywordHarvest.js';
...
import { DEFAULT_COVERAGE_AUDIT_REPORT_PATH, DEFAULT_COVERAGE_QUERY_FILE_PATH, DEFAULT_COVERAGE_ACTION_FILE_PATH } from '../utils/paths.js';
const reportPath = process.env.BILIBILI_COVERAGE_AUDIT_REPORT_PATH || DEFAULT_COVERAGE_AUDIT_REPORT_PATH;
const queryFilePath = process.env.BILIBILI_COVERAGE_QUERY_FILE_PATH || DEFAULT_COVERAGE_QUERY_FILE_PATH;
const actionFilePath = process.env.BILIBILI_COVERAGE_ACTION_FILE_PATH || DEFAULT_COVERAGE_ACTION_FILE_PATH;
