...
STOP_TERMS.add('\u75c5\u5f2f\u94a9');
STOP_TERMS.add('\u5c2c\u5230\u62a0\u811a');
STOP_TERMS.add('\u4e0d\u7edd\u5bf9\u4f46\u97e9\u56fd\u4e0d\u5c11');
STOP_TERMS.add('\u8d5b\u5b63\u86cb');
STOP_TERMS.add('\u7761\u524d\u5c0f\u751c\u997c');
STOP_TERMS.add('\u5c0f\u751c\u997c');
STOP_TERMS.add('\u76f4\u7537\u4e0d\u7ba1\u5bf9\u65b9\u53eb\u8001\u5a46');
STOP_TERMS.add('\u4e0d\u4e89\u4e0d\u62a2\u5ab3\u5987\u513f\u5c31\u98de\u4e86');
STOP_TERMS.add('\u4e0d\u77e5\u9053ai\u5ba1\u6838');
STOP_TERMS.add('\u538b\u529b\u6765\u5230\u4e86\u5c0f\u7334\u8fd9\u8fb9');
STOP_TERMS.add('\u4e0d\u8bd7\u4eba');
STOP_TERMS.add('\u989c\u503c\u8eab\u6750\u6ca1\u6709\u77ed\u677f');
STOP_TERMS.add('\u5168\u635f\u97f3\u54c1\u8d28');
STOP_TERMS.add('\u6709\u4e00\u70b9\u75d4\u75ae');
STOP_TERMS.add('\u660e\u5929\u6765\u4e0a\u73ed');
STOP_TERMS.add('\u6ca1\u4eba\u5417');
STOP_TERMS.add('\u77e5\u8bc6\u76f2\u533a');
STOP_TERMS.add('\u4ea7\u51fa\u4e0d\u6613');
...
STOP_TERMS.add('\u62c9\u5938');
STOP_TERMS.add('\u5f88\u68d2\u5148\u751f');
STOP_TERMS.add('\u6211\u5c06\u652f\u4ed8\u60a8\u753b\u753b\u7684\u8d39\u7528');
STOP_TERMS.add('\u8fd9\u5f88\u68d2\u5148\u751f');
STOP_TERMS.add('\u76f4\u8a00\u4e0d\u8bb3');
STOP_TERMS.add('\u8349\u751f');
STOP_TERMS.add('\u798f\u745e\u63a7');
STOP_TERMS.add('\u5e3d\u5b50\u53d4');
STOP_TERMS.add('\u5e3d\u5b50\u53d4\u53d4');
STOP_TERMS.add('\u5c0f\u9ec4\u9c7c');
STOP_TERMS.add('\u4e94\u7ef4\u56fe\u5168\u90fd\u4f4e\u7684\u53ef\u601c');
STOP_TERMS.add('\u6253\u4e86\u81ea\u5df1\u7535\u8bdd');
STOP_TERMS.add('up\u597d\u725b');
STOP_TERMS.add('\u8098\u904d\u5168\u7f51');
STOP_TERMS.add('\u4f0a\u5229\u4e9a\u6211\u8f6f\u811a\u4e86');
STOP_TERMS.add('\u4f0a\u8389\u96c5\u6211\u8f6f\u811a\u4e86');
STOP_TERMS.add('\u4e2a\u7b7e');
...
STOP_TERMS.add('\u5ddd\u5efa\u56fd');
STOP_TERMS.add('\u5ddd\u666e');
STOP_TERMS.add('\u675c\u752b\u7b2c\u4e00\u674e\u767d\u4e0d\u53c2\u4e0e\u6392\u540d');
STOP_TERMS.add('\u674e\u767d\u4e0d\u53c2\u4e0e\u6392\u540d');
STOP_TERMS.add('\u5168\u662f\u6211\u4eec\u9a6c\u54e5');
STOP_TERMS.add('\u4f1a\u4e91\u591a\u4e91');
STOP_TERMS.add('\u5c0f\u53d4\u6587\u5b66');
STOP_TERMS.add('\u53d1\u73b0\u5168\u662f\u7f3a');
STOP_TERMS.add('\u6392\u957f');
STOP_TERMS.add('\u7262\u7956\u51b2\u4e4b');
STOP_TERMS.add('\u8fd0\u6c14\u771f\u597d');
STOP_TERMS.add('\u7092\u9e21\u597d\u7528');
STOP_TERMS.add('\u90fd\u662f\u5bb6\u4eba');
STOP_TERMS.add('\u6050\u6016\u7ae5\u8c23\u7edd\u5bf9\u7b2c\u4e00');
STOP_TERMS.add('py\u73b0\u573a');
STOP_TERMS.add('\u5173\u6ce8\u529b');
STOP_TERMS.add('\u4e09\u8054');
STOP_TERMS.add('\u9ad8\u5983\u5e94\u5f97\u7684\u5f85\u9047');
STOP_TERMS.add('\u6b63\u9053\u7684\u5149');
STOP_TERMS.add('\u659c\u773c\u7b11');
STOP_TERMS.add('tv\u659c\u773c\u7b11');
STOP_TERMS.add('\u6897out\u4e86');
STOP_TERMS.add('out\u4e86');
STOP_TERMS.add('\u76d1\u72f1\u6765\u7684\u5988\u5988');
STOP_TERMS.add('\u5c0fup');
STOP_TERMS.add('\u5343\u5e74\u662f\u54ee\u5929\u72ac');
STOP_TERMS.add('\u539f\u6765\u4f60\u4e5f\u73a9\u539f\u795e');
STOP_TERMS.add('\u5e7f\u4e1c\u7684');
STOP_TERMS.add('\u7b11\u563b\u4e86');
STOP_TERMS.add('\u62d4\u7fa4');
STOP_TERMS.add('\u6548\u679c\u62d4\u7fa4');
STOP_TERMS.add('\u7f57\u795e\u4f1f\u5927');
STOP_TERMS.add('\u56fd\u9645\u5b85\u7537\u8054\u76df');
STOP_TERMS.add('\u5b85\u7537\u8054\u76df');
STOP_TERMS.add('\u597d\u65f6\u4ee3\u6765\u4e34\u529b');
STOP_TERMS.add('\u6218\u7ee9\u6e05\u96f6\u5361');
STOP_TERMS.add('\u95ee\u8001\u9a6c\u672c\u4eba');
STOP_TERMS.add('\u4e09\u5e74\u5c31\u8d70\u4e86');
STOP_TERMS.add('\u597d\u78d5\u7684\u5f88');
STOP_TERMS.add('\u54b1\u4eec\u773c\u5149\u4e00\u6837');
STOP_TERMS.add('\u5feb\u901f\u5e73\u6574');
STOP_TERMS.add('\u5e73\u6574\u5668');
STOP_TERMS.add('\u571f\u5730\u5feb\u901f\u5e73\u6574\u5668');
STOP_TERMS.add('\u751c\u83dc');
STOP_TERMS.add('\u9ed1\u9676\u6e0a\u660e');
STOP_TERMS.add('\u4e7e\u9686\u8001\u513f');
STOP_TERMS.add('\u7834\u4e86\u76f8\u4e86');
STOP_TERMS.add('\u4e00\u66f2\u5fe0\u8bda\u7684\u8d5e\u6b4c');
STOP_TERMS.add('cos\u8def\u6613\u5341\u516d');
STOP_TERMS.add('\u89c6\u9891\u5168\u90fd\u4e0d\u89c1\u4e86');
STOP_TERMS.add('\u7ea2\u83b2\u4e1a\u706b\u711a\u6211\u8eab');
STOP_TERMS.add('dj\u5982\u6765');
STOP_TERMS.add('\u4f60\u609f\u4e86');
...
STOP_TERMS.add('\u7edd\u5bf9\u4e5f\u662f');
STOP_TERMS.add('\u7edd\u5bf9\u4e3b\u7ebf');
STOP_TERMS.add('\u7edd\u5bf9\u662f\u8d28\u91cf\u95ee\u9898');
STOP_TERMS.add('\u7edd\u5bf9\u6709\u95ee\u9898\u7684');
STOP_TERMS.add('\u7edd\u6d3b\u5f3a\u5ea6');
STOP_TERMS.add('\u5f00\u56fd\u7684\u65f6\u5019');
STOP_TERMS.add('\u5f00\u723d\u54af');
...
STOP_TERMS.add('\u80ef\u7fa4\u6267\u6cd5');
STOP_TERMS.add('\u5feb\u4e50\u4e00\u8d5b\u5b63\u96be\u8fc7\u603b\u51b3\u8d5b');
STOP_TERMS.add('\u62c9\u6905\u5b50');
STOP_TERMS.add('\u84dd\u7626\u9999\u83c7');
STOP_TERMS.add('\u7262\u5c06');
STOP_TERMS.add('\u7262\u4f1f');
STOP_TERMS.add('\u8001\u5e08\u56fe\u7247\u53ef\u4ee5\u62ff\u5417');
STOP_TERMS.add('\u674e\u6c0f\u7236\u5b50');
STOP_TERMS.add('\u91cc\u9762\u5168\u662f\u9502\u7535\u6c60');
STOP_TERMS.add('\u8054\u52a8\u676f');
STOP_TERMS.add('\u4e24\u60c5\u76f8\u60a6');
STOP_TERMS.add('\u91cf\u5b50\u76d1\u63a7\u6444\u50cf\u5934');
STOP_TERMS.add('\u516d\u6247\u95e8');
STOP_TERMS.add('\u8f6e\u6905\u8f74');
...
import { DEFAULT_DICTIONARY_PATH as DATA_DICTIONARY_PATH } from '../utils/paths.js';
export const DEFAULT_DICTIONARY_PATH = process.env.DEEPSEEK_KEYWORD_DICTIONARY_PATH || DATA_DICTIONARY_PATH;
...
function prioritizeEvidenceSourcesForSamples(evidenceSources = [], evidenceSamples = [], limit = 8) {
  const sampleOrder = new Map((evidenceSamples || []).map((sample, index) => [String(sample || '').trim(), index]));
  const preferred = [];
  const seenPreferredSamples = new Set();
  const sourceKey = (source) => `${source?.source || ''}\n${source?.uid || ''}\n${source?.sample || ''}`;
  const sortedSources = [...(evidenceSources || [])].sort((a, b) => {
    const contextDelta = evidenceSourceSortKey(a) - evidenceSourceSortKey(b);
    if (contextDelta !== 0) return contextDelta;
    const aOrder = sampleOrder.has(String(a?.sample || '').trim()) ? sampleOrder.get(String(a?.sample || '').trim()) : Number.MAX_SAFE_INTEGER;
    const bOrder = sampleOrder.has(String(b?.sample || '').trim()) ? sampleOrder.get(String(b?.sample || '').trim()) : Number.MAX_SAFE_INTEGER;
    return aOrder - bOrder;
  });

  for (const source of sortedSources) {
    const sample = String(source?.sample || '').trim();
    if (!sample || !sampleOrder.has(sample) || isVideoContextSource(source) || seenPreferredSamples.has(sample)) continue;
    preferred.push(source);
    seenPreferredSamples.add(sample);
  }
...
function mergeKeywordEntry(existing, incoming, now) {
  ...
  const existingSampleSet = new Set((existing.evidenceSamples || []).map((sample) => String(sample || '').trim()).filter(Boolean));
  const incomingSampleSet = new Set((incoming.evidenceSamples || []).map((sample) => String(sample || '').trim()).filter(Boolean));
  const mergedEvidenceSamples = unique([...(existing.evidenceSamples || []), ...(incoming.evidenceSamples || [])]);
  const filteredEvidenceSamples = mergedEvidenceSamples
    .filter((sample) => !isAmbiguousBenignEvidenceSample(incoming.term, targetFamily, sample));
  const hasSampleCapPressure = filteredEvidenceSamples.length > 5;
  const evidenceSamples = filteredEvidenceSamples
    .sort((a, b) => {
      const sampleDelta = evidenceSampleSortKey(a) - evidenceSampleSortKey(b);
      if (sampleDelta !== 0) return sampleDelta;
      const aClean = String(a || '').trim();
      const bClean = String(b || '').trim();
      const aFreshIncoming = incomingSampleSet.has(aClean) && !existingSampleSet.has(aClean);
      const bFreshIncoming = incomingSampleSet.has(bClean) && !existingSampleSet.has(bClean);
      if (hasSampleCapPressure && aFreshIncoming !== bFreshIncoming) return aFreshIncoming ? -1 : 1;
      return 0;
    })
    .slice(0, 5);
  ...
  const filteredEvidenceSources = uniqueBy(
    [...(existing.evidenceSources || []), ...(incoming.evidenceSources || [])].sort(
      (a, b) => evidenceSourceSortKey(a) - evidenceSourceSortKey(b),
    ),
    (item) => `${item.source || ''}\n${item.uid || ''}\n${item.sample || ''}`,
  ...
  const evidenceSources = prioritizeEvidenceSourcesForSamples(filteredEvidenceSources, evidenceSamples, 8);
...
export function normalizeKeywordEntries(rawEntries = []) {
  ...
  for (const item of rawEntries) {
    ...
    for (const term of terms) {
      ...
      const candidateEvidenceSamples =
        term === '\u53ef\u4ee5\u8d34' && family === 'cooperation'
          ? rawEvidenceSamples.filter((sample) => !isNoisyEvidenceSample(sample))
          : evidenceSamples;
      const termEvidenceSamples = candidateEvidenceSamples.filter((sample) => !isAmbiguousBenignEvidenceSample(term, family, sample)).slice(0, 5);
      ...
      if (term === '\u6b27\u9633\u5a1c\u5a1c' && family === 'evidence' && sampleBackedEvidenceCount === 0) continue;
      const evidenceCount =
        sampleBackedEvidenceCount > 0
...
function generatedEvidenceAliasesForTerm(term) {
  ...
  if (clean.startsWith('\u8fd9\u8c01\u80fd') && clean.length > 3) aliases.push(`\u8fd9\u8c01${clean.slice(3)}`);
  if (clean.includes('\u6ca1\u89c1\u8fc7\u4e0d\u4ee3\u8868\u6ca1\u6709')) {
    aliases.push(
      clean.replace('\u6ca1\u89c1\u8fc7\u4e0d\u4ee3\u8868\u6ca1\u6709', '\u4e0d\u77e5\u9053\u4e0d\u4ee3\u8868\u6ca1\u6709'),
      clean.replace('\u6ca1\u89c1\u8fc7\u4e0d\u4ee3\u8868\u6ca1\u6709', '\u6ca1\u770b\u8fc7\u4e0d\u4ee3\u8868\u6ca1\u6709'),
    );
  }
...
export function evidenceNeedlesForTerm(term) {
  return unique([
    term,
...
function isAmbiguousBenignEvidenceSample(term, family, sample) {
  ...
  if (term === '\u6840\u6840\u6840' && family === 'attack') {
    ...
    const hostileVillainLaughContext = /(?:\u4f60|\u4f60\u4e2a|\u9003\u5f97\u51fa|\u624b\u638c\u5fc3|\u53d8\u6210\u788e\u672b|\u788e\u672b|\u4e0d\u80fd\u5566|\u9b54\u5934|\u53cd\u6d3e).{0,24}\u6840\u6840\u6840|\u6840\u6840\u6840.{0,24}(?:\u4f60|\u9003\u5f97\u51fa|\u624b\u638c\u5fc3|\u53d8\u6210\u788e\u672b|\u788e\u672b|\u4e0d\u80fd\u5566|\u9b54\u5934|\u53cd\u6d3e)/u.test(cleanSample);
    if (laughExplanationContext && !hostileVillainLaughContext) return true;
  }
  if (term === '\u4e94\u6bd2\u4ff1\u5168' && family === 'attack') {
    const gameMechanicContext = /\u4e94\u6bd2\u4ff1\u5168.{0,12}(?:\u6548\u679c|\u6b63\u9762|\u8d1f\u9762|\u90fd\u7b97|\u6280\u80fd|\u52a0\u6210)|(?:\u6548\u679c|\u6b63\u9762|\u8d1f\u9762|\u6280\u80fd|\u52a0\u6210).{0,12}\u4e94\u6bd2\u4ff1\u5168/u.test(cleanSample);
    const attackContext = /(?:\u4e24\u516c\u6bcd|\u8fd9\u4e9b\u4eba|\u5b66\u4e2a\u8bcd|\u5230\u5904\u7528|\u4eba|\u4ed6|\u4f60|\u7c89\u4e1d).{0,24}\u4e94\u6bd2\u4ff1\u5168|\u4e94\u6bd2\u4ff1\u5168.{0,24}(?:\u4e24\u516c\u6bcd|\u8fd9\u4e9b\u4eba|\u5b66\u4e2a\u8bcd|\u5230\u5904\u7528|\u4eba|\u4ed6|\u4f60|\u7c89\u4e1d)/u.test(cleanSample);
    if (gameMechanicContext && !attackContext) return true;
  }
  if (['100\u597d\u8bc4', '\u767e\u5206\u767e\u597d\u8bc4\u7387'].includes(term) && family === 'absolutes') {
    const literalCommerceReviewContext = /(?:\u95f2\u9c7c|\u8bc4\u4ef7\d+|\u597d\u8bc4\d+|\u5dee\u8bc4\d+|\u8d29\u5b50|\u4e70\u8fc7|\u5356\u8fc7|\u5356\u5bb6|\u5546\u54c1|\u4e70\u4e1c\u897f).{0,36}(?:100%?\u597d\u8bc4|\u767e\u5206\u767e\u597d\u8bc4\u7387|\u767e\u5206\u767e\u597d\u8bc4)|(?:100%?\u597d\u8bc4|\u767e\u5206\u767e\u597d\u8bc4\u7387|\u767e\u5206\u767e\u597d\u8bc4).{0,36}(?:\u95f2\u9c7c|\u8bc4\u4ef7\d+|\u597d\u8bc4\d+|\u5dee\u8bc4\d+|\u8d29\u5b50|\u4e70\u8fc7|\u5356\u8fc7|\u5356\u5bb6|\u5546\u54c1|\u4e70\u4e1c\u897f)|(?:\u6211\u5c31\u662f|\u6211\u662f|\u81ea\u5df1).{0,12}\u767e\u5206\u767e\u597d\u8bc4/u.test(cleanSample);
    const absolutistArgumentContext = /(?:\u903b\u8f91|\u4e00\u70b9\u95ee\u9898|\u4e0d\u8bb8\u63d0|\u8fd9\u4e48\u7edd\u5bf9|\u4e5f\u6562\u8bf4|\u6ca1\u6c34\u5206|\u8bdd\u672f|\u7ed3\u8bba).{0,36}(?:100\u597d\u8bc4|\u767e\u5206\u767e\u597d\u8bc4\u7387)|(?:100\u597d\u8bc4|\u767e\u5206\u767e\u597d\u8bc4\u7387).{0,36}(?:\u903b\u8f91|\u4e00\u70b9\u95ee\u9898|\u4e0d\u8bb8\u63d0|\u8fd9\u4e48\u7edd\u5bf9|\u4e5f\u6562\u8bf4|\u6ca1\u6c34\u5206|\u8bdd\u672f|\u7ed3\u8bba)/u.test(cleanSample);
    if (literalCommerceReviewContext && !absolutistArgumentContext) return true;
  }
  if (term === '\u5dee\u8bc4\u8fde\u5929' && family === 'evidence') {
    const literalCommerceComplaintContext = /(?:\u4e70|\u5546\u54c1|\u5546\u5bb6|\u5356\u5bb6|\u4e70\u5bb6|\u95f2\u9c7c|\u8bc4\u4ef7).{0,36}\u5dee\u8bc4\u8fde\u5929|\u5dee\u8bc4\u8fde\u5929.{0,36}(?:\u4e70|\u5546\u54c1|\u5546\u5bb6|\u5356\u5bb6|\u4e70\u5bb6|\u95f2\u9c7c|\u8bc4\u4ef7)/u.test(cleanSample);
    const evidenceContext = /(?:\u53bb\u770b|\u8bb0\u5f55|\u8bc4\u8bba\u533a|\u8bc1\u636e|\u6765\u6e90|\u53ef\u4ee5\u67e5).{0,36}\u5dee\u8bc4\u8fde\u5929|\u5dee\u8bc4\u8fde\u5929.{0,36}(?:\u8bc1\u636e|\u6765\u6e90|\u53ef\u4ee5\u67e5|\u8bb0\u5f55)/u.test(cleanSample);
    if (literalCommerceComplaintContext && !evidenceContext) return true;
  }
  ...
  if (term === '\u68a6\u7537' && family === 'attack') {
    const selfOrNeutralFandomContext = /(?:\u6211\u4e5f\u662f|\u81ea\u5df1\u662f|\u68a6\u7537\u8fd8\u55d1cp\u7684\u5417|\u68a6\u7537.*(?:\u5417|\uff1f|\?))|(?:\u5999\u754c\u68a6\u7537|\u68a6\u5973)/u.test(cleanSample);
    const hostileFandomContext = /(?:\u4e0d\u6127\u662f|\u5632|\u9ed1|\u63a7\u8bc4|\u6025|\u6076\u5fc3|\u610f\u6deb|\u5e7b\u60f3).{0,18}\u68a6\u7537|\u68a6\u7537.{0,18}(?:\u4e0d\u6127\u662f|\u63a7\u8bc4|\u6025|\u6076\u5fc3|\u610f\u6deb|\u5e7b\u60f3|\u7834\u9632)/u.test(cleanSample);
    if (selfOrNeutralFandomContext && !hostileFandomContext) return true;
  }
  ...
  if (term === '\u5764\u5df4' && family === 'attack') {
    const usernameOrMentionContext = /(?:^@\S*\u5764\u5df4\S*$|\u56de\u590d\s*@\S*\u5764\u5df4|(?:\u6e38\u620fID|\bID\b|\u540d\u5b57|\u6635\u79f0|\u81ea\u521b|\u72ec\u95e8\u8bcd).{0,24}\u5764\u5df4|\u5764\u5df4.{0,24}(?:\u6e38\u620fID|\bID\b|\u540d\u5b57|\u6635\u79f0|\u666e\u53ca|\u81ea\u521b|\u72ec\u95e8\u8bcd)|\u6807\u9898.{0,12}(?:\u6539\u6210|\u88ab\u8feb).{0,12}\u5764\u5df4)/iu.test(cleanSample)
      || /(?:^@\S*\u5764\u5df4\S*$|\u56de\u590d\s*@\S*\u5764\u5df4)/u.test(rawContextSample);
    const hostileSlurContext = /(?:\u4f60|\u4ed6|\u8fd9\u4eba|\u7d20\u8d28|\u771f|\u50bb|\u6076\u5fc3|\u5dee|\u9a82|\u6eda).{0,12}\u5764\u5df4|\u5764\u5df4.{0,12}(?:\u5dee|\u50bb|\u6076\u5fc3|\u6eda|\u73a9\u610f|\u4e1c\u897f)/u.test(cleanSample);
    if (usernameOrMentionContext && !hostileSlurContext) return true;
  }
  ...
  if (['\u849c\u8304\u8111\u888b', '\u849c\u8304\u8111\u74dc'].includes(term) && family === 'attack') {
    const glossaryOrEtymologyContext = /(?:^|\u56de\u590d.*)\u662f\u849c\u8304\u8111\u74dc$|(?:\u4e1c\u5317|\u849c\u6ce5\u8304\u5b50|\u52a0\u4e00\u8d77\u5c31\u662f|\u662f\u849c\u8304\u8111\u74dc|\u5f88\u5f62\u8c61|\u5f62\u5bb9|\u610f\u601d|\u9ed1\u79f0).{0,28}\u849c\u8304\u8111(?:\u888b|\u74dc)|\u849c\u8304\u8111(?:\u888b|\u74dc).{0,28}(?:\u4e1c\u5317|\u849c\u6ce5\u8304\u5b50|\u52a0\u4e00\u8d77\u5c31\u662f|\u5f88\u5f62\u8c61|\u5f62\u5bb9|\u610f\u601d|\u9ed1\u79f0)/u.test(cleanSample);
    const directedInsultContext = /(?:\u4f60|\u4ed6|\u5979|\u8fd9\u4eba|\u7c89\u4e1d|\u8111\u5b50|\u771f|\u522b|\u50cf).{0,18}\u849c\u8304\u8111(?:\u888b|\u74dc)|\u849c\u8304\u8111(?:\u888b|\u74dc).{0,18}(?:\u5427|\u4e86|\u8111\u5b50|\u771f\u8822|\u50cf|\u8fd9\u4eba|\u7c89\u4e1d)/u.test(cleanSample);
    if (glossaryOrEtymologyContext && !directedInsultContext) return true;
  }
  if (term === '\u5927\u9b54\u6cd5\u5e08' && family === 'attack') {
    const literalFantasyContext = /(?:\u6b32\u795e\u5e7b\u60f3|\u9732\u5983|\u6280\u80fd\u6a21\u7ec4|\u7fa4\u653b|\u9b54\u79d1|\u80dc\u5229\u9f99|link|\u9b54\u6cd5\u5e08\u5957\u88c5|\u9b54\u6cd5\u5e08.{0,12}(?:\u5957\u88c5|\u6280\u80fd|\u6a21\u7ec4|\u7fa4\u653b|\u804c\u4e1a|\u6e38\u620f|\u52a8\u6f2b|\u7535\u5f71|\u53d8\u6210|\u9b54\u79d1)|(?:\u524d\u671f|\u540e\u671f|\u4e70\u4e70|\u6e38\u620f|\u804c\u4e1a|\u89d2\u8272|\u5361\u724c|\u88c5\u5907|\u5957\u88c5|\u6280\u80fd|\u9b54\u79d1|\u80dc\u5229\u9f99|link).{0,18}\u9b54\u6cd5\u5e08)/iu.test(cleanSample);
    const mediaTitleContext = /(?:\u7537\u4eba\u5355\u8eab30\u5c81\u5c31\u4f1a\u53d8\u6210\u9b54\u6cd5\u5e08|\u5355\u8eab30\u5c81\u5c31\u4f1a\u53d8\u6210\u9b54\u6cd5\u5e08|\u300a[^\\n\u300b]*\u9b54\u6cd5\u5e08[^\\n\u300b]*\u300b|\u91cd\u770b|\u70b9\u83dc).{0,24}\u9b54\u6cd5\u5e08|\u9b54\u6cd5\u5e08.{0,24}(?:\u5267|\u756a|\u7537\u4e3b|\u7535\u5f71|\u52a8\u6f2b|\u7eed\u96c6|\u91cd\u770b|\u70b9\u83dc)/u.test(cleanSample);
  ...
  if (term === '\u8499\u9f13\u4eba' && family === 'cooperation') {
    const explanationContext = /(?:\u89e3\u91ca|\u4ec0\u4e48\u53eb|\u8bb2|\u8fd9\u4e2aUP\u4e3b|\u6897\u767e\u79d1|\u5982[:\uff1a]).{0,24}\u8499\u9f13\u4eba|\u8499\u9f13\u4eba.{0,24}(?:\u7684\u6897|\u800c\u4e0d\u662f\u8499\u53e4\u4eba|\u4ec0\u4e48\u6897|\u4ec0\u4e48\u53eb)/u.test(cleanSample);
    const thanksContext = /(?:\u8c22\u8c22|\u611f\u8c22|\u591a\u8c22).{0,8}\u8499\u9f13\u4eba|\u8499\u9f13\u4eba.{0,8}(?:\u8c22\u8c22|\u611f\u8c22|\u591a\u8c22)/u.test(cleanSample);
    if (explanationContext && !thanksContext) return true;
  }
  if (term === '\u8fd9\u91cc\u6709\u4e2a\u8001\u5b9e\u4eba' && family === 'cooperation') {
    const explanationContext = /(?:\u8fd9\u4e2a\u6897|\u524d\u8eab|\u4e00\u822c\u90fd\u662f\u8bf4|\u4ec0\u4e48\u6897).{0,24}\u8fd9\u91cc\u6709\u4e2a\u8001\u5b9e\u4eba|\u8fd9\u91cc\u6709\u4e2a\u8001\u5b9e\u4eba.{0,24}(?:\u524d\u8eab|\u4ec0\u4e48\u6897|\u4e00\u822c)/u.test(cleanSample);
    const playfulCalloutContext = /(?:\u5feb\u6765\u770b|\u5feb\u770b|\u6293\u5230|\u54c8\u54c8).{0,18}\u8fd9\u91cc\u6709\u4e2a\u8001\u5b9e\u4eba|\u8fd9\u91cc\u6709\u4e2a\u8001\u5b9e\u4eba.{0,18}(?:\u54c8\u54c8|\u4e86)/u.test(cleanSample);
    if (explanationContext && !playfulCalloutContext) return true;
  }
  if (term === '\u60a8\u914d\u5417' && family === 'attack') {
    const memeOriginContext = /(?:\u836f\u6c34\u54e5|\u56e0\u4e3a|\u77e5\u9053|\u706b\u8d77\u6765|\u540d\u573a\u9762|\u4e4b\u4e89).{0,24}\u60a8\u914d\u5417|\u60a8\u914d\u5417.{0,24}(?:\u836f\u6c34\u54e5|\u706b\u8d77\u6765|\u77e5\u9053|\u540d\u573a\u9762|\u4e4b\u4e89)/u.test(cleanSample);
    const directChallengeContext = /(?:\u4f60|\u4f60\u4eec|\u4ed6|\u5979|\u81ea\u5df1|\u771f\u628a\u81ea\u5df1|\u9053\u5fb7\u5236\u9ad8\u70b9|\u5723\u4eba).{0,36}\u60a8\u914d\u5417|\u60a8\u914d\u5417.{0,24}(?:\u7ad9\u5728|\u4f60|\u4f60\u4eec|\u4ed6|\u5979|\u914d\u5417)/u.test(cleanSample);
    if (memeOriginContext && !directChallengeContext) return true;
  }
  if (term === '\u6b27\u9633\u5a1c\u5a1c' && family === 'evidence') {
    const celebrityMentionContext = /\u6b27\u9633\u5a1c\u5a1c/u.test(cleanSample);
    const evidenceRequestContext = /(?:\u6765\u6e90|\u8bc1\u636e|\u94fe\u63a5|\u539f\u6587|\u91c7\u8bbf|\u8c01\u8bf4\u7684|\u51fa\u5904|\u8d34).{0,24}\u6b27\u9633\u5a1c\u5a1c|\u6b27\u9633\u5a1c\u5a1c.{0,24}(?:\u6765\u6e90|\u8bc1\u636e|\u94fe\u63a5|\u539f\u6587|\u91c7\u8bbf|\u8c01\u8bf4\u7684|\u51fa\u5904|\u8d34)/u.test(cleanSample);
    if (celebrityMentionContext && !evidenceRequestContext) return true;
  }
  ...
  if (term === '\u4e2a\u7b7e' && family === 'cooperation') {
    const profileSignatureContext = /(?:\u6211\u7684\u4e2a\u7b7e|\u6362\u4e2a\u7b7e|\u770b\u6211\u4e2a\u7b7e|\u4e2a\u6027\u7b7e\u540d|\u4e2a\u7b7e\u6709\u94fe\u63a5|\u4e2a\u7b7e\u662f|\u4e0a\u4e0a\u7b7e|\u62bd\u4e2a\u7b7e|\u7b7e\u7ed8\u677f)|Bilibili public video title:/u.test(cleanSample);
    const negatedEvidenceContext = /(?:\u4e0d\u662f|\u6ca1\u6709|\u6ca1)\u4ec0\u4e48?\u8bc1\u636e|(?:\u4e0d\u662f|\u6ca1\u6709|\u6ca1).{0,8}\u8bc1\u636e/u.test(cleanSample);
    const discussionContext = /\u4e2a\u7b7e.{0,18}(?:\u8bc1\u636e|\u6765\u6e90|\u539f\u6587|\u622a\u56fe|\u8d34\u51fa)|(?:\u8bc1\u636e|\u6765\u6e90|\u539f\u6587|\u622a\u56fe).{0,18}\u4e2a\u7b7e/u.test(cleanSample);
    if (profileSignatureContext && (!discussionContext || negatedEvidenceContext)) return true;
  }
  if (term === '\u7ed9\u7b5b\u5b50\u91cc\u704c\u4e86\u94c5' && family === 'attack') {
    const literalTitleContext = /Bilibili public video title:|\u300a\u6211\u4eec\u7ed9\u7b5b\u5b50\u91cc\u704c\u4e86\u94c5\u300b/u.test(rawContextSample);
    const literalGameMechanicContext = literalTitleContext
      || /(?:\u4e91\u9876|\u5361\u724c|\u724c\u5e93|\u65e0\u9650\u706b\u529b|\u704c\u94c5\u7b5b\u5b50|\u4e09\u661f|\u8d4f\u91d1|\u59ae\u853b|\u6c83\u91cc\u514b|\u91d1\u94f2\u94f2).{0,48}(?:\u7b5b\u5b50|\u704c\u94c5|\u7ed9\u7b5b\u5b50\u91cc\u704c\u4e86\u94c5)|(?:\u7ed9\u7b5b\u5b50\u91cc\u704c\u4e86\u94c5|\u704c\u94c5\u7b5b\u5b50).{0,48}(?:\u4e91\u9876|\u5361\u724c|\u724c\u5e93|\u65e0\u9650\u706b\u529b|\u4e09\u661f|\u8d4f\u91d1|\u59ae\u853b|\u6c83\u91cc\u514b|\u91d1\u94f2\u94f2)/u.test(cleanSample);
    const probabilityAttackContext = /(?:\u6982\u7387|\u6697\u6539|\u64cd\u7eb5|\u9ed1\u5e55|\u4f5c\u5047|\u9a97|\u7cfb\u7edf|\u5b98\u65b9).{0,24}(?:\u7ed9\u7b5b\u5b50\u91cc\u704c\u4e86\u94c5|\u704c\u94c5\u7b5b\u5b50)|(?:\u7ed9\u7b5b\u5b50\u91cc\u704c\u4e86\u94c5|\u704c\u94c5\u7b5b\u5b50).{0,24}(?:\u6982\u7387|\u6697\u6539|\u64cd\u7eb5|\u9ed1\u5e55|\u4f5c\u5047|\u9a97|\u7cfb\u7edf|\u5b98\u65b9)/u.test(cleanSample);
    if (literalGameMechanicContext && !probabilityAttackContext) return true;
  }
  ...
  if (term === '\u53ef\u4ee5\u8d34' && family === 'cooperation') {
    ...
    const genericPublishCapabilityContext =
      ...
      /(?:\u53ef\u4ee5\u53d1.{0,10}(?:\u56fe\u7247|\u56fe|\u8bed\u97f3|\u5f39\u5e55|\u8bc4\u8bba|\u8bba\u6587|\u5fae\u535a|\u52a8\u6001|\u89c6\u9891|\u8d22|\u53f0\u8bcd\u5305)|\u8c01\u5bb6.{0,8}\u53ef\u4ee5\u53d1\u5f39\u5e55|\u7ec8\u4e8e\u53ef\u4ee5\u53d1.{0,10}\u56fe\u7247)/u.test(cleanSample);
    ...
    const productLinkRequestContext = !cleanSample.includes('\u53ef\u4ee5\u8d34') && /(?:\u536b\u8863|\u5916\u5957|\u7c89\u8272|\u540c\u6b3e|\u8863\u670d|\u5546\u54c1|\u5e97\u94fa).{0,18}(?:\u53ef\u4ee5\u53d1|\u53d1\u6211).{0,8}\u94fe\u63a5|\u53d1\u6211\u94fe\u63a5.{0,18}(?:\u536b\u8863|\u5916\u5957|\u7c89\u8272|\u540c\u6b3e|\u8863\u670d|\u5546\u54c1|\u5e97\u94fa)/u.test(cleanSample);
    const imagePostingHelpContext = !cleanSample.includes('\u53ef\u4ee5\u8d34') && /(?:\u56fe\u7247|\u8868\u60c5|\u7167\u7247).{0,8}(?:\u600e\u4e48|\u5982\u4f55).{0,8}\u53d1\u51fa\u6765|\u600e\u4e48\u53d1\u51fa\u6765.{0,8}(?:\u56fe\u7247|\u8868\u60c5|\u7167\u7247)?/u.test(cleanSample);
    const cooperativeSourceContext = /(?:\u53ef\u4ee5\u8d34|\u5efa\u8bae\u8d34|\u9ebb\u70e6\u8d34|\u53ef\u4ee5\u53d1).*(?:\u6765\u6e90|\u8bc1\u636e|\u622a\u56fe|\u94fe\u63a5|\u539f\u6587|\u5bf9\u7167)|(?:\u8bc4\u8bba|\u8bc1\u636e).{0,8}\u8d34\u51fa\u6765/u.test(cleanSample);
    if (productLinkRequestContext || imagePostingHelpContext) return true;
    if (
      (
        hostileDareContext ||
        genericDiscoveryContext ||
        genericAdviceContext ||
        loosePublishContext ||
        looseCapabilityContext ||
        genericPublishCapabilityContext ||
        guruMonologueContext ||
        resourceShareContext ||
        labelAttachmentContext
      ) &&
      !cooperativeSourceContext
    ) {
      return true;
    }
  }
  ...
  if (['\u7f8e\u54c9', '\u5c82\u4e0d\u7f8e\u54c9'].includes(term) && family === 'attack') {
    const bareRhetoricalPhrase = /^(?:\u5c82\u4e0d)?\u7f8e\u54c9[\s!！。？?]*$/u.test(cleanSample);
    const targetedSarcasmContext = /(?:\u6263\u5e3d\u5b50|\u9020\u8c23|\u88c5|\u6d17|\u53cc\u6807|\u8bdd\u672f|\u53d7\u5bb3\u8005|\u7406\u4e2d\u5ba2|\u4f60|\u4f60\u4eec).{0,24}(?:\u5c82\u4e0d)?\u7f8e\u54c9|(?:\u5c82\u4e0d)?\u7f8e\u54c9.{0,24}(?:\u6263\u5e3d\u5b50|\u9020\u8c23|\u88c5|\u6d17|\u53cc\u6807|\u8bdd\u672f)/u.test(cleanSample);
    if (bareRhetoricalPhrase && !targetedSarcasmContext) return true;
  }
  if (term === '\u8d5b\u5bc4' && family === 'attack') {
  ...
  if (term === '\u5f02\u8bae' && family === 'attack') {
    ...
    const neutralLegalOrPoliticalContext = /(?:\u4e94\u5e74\u7ea7\u5f02\u8bae\u4e0e\u53cd\u5bf9|\u5f8b\u5e08\u5fbd\u7ae0|\u6bcf\u4e2a\u5f02\u8bae|\u5408\u4f5c\u534f\u8bae|\u5185\u90e8\u6709\u5f02\u8bae|\u63d0\u51fa\u5f02\u8bae|\u5f02\u8bae\u6743|\u5f02\u8bae\u4eba|\u5f02\u8bae\u4e66)/u.test(cleanSample);
    const disputeContext = /\u5f02\u8bae.{0,18}(?:\u8bc1\u636e|\u8bf4\u6cd5|\u53cd\u5bf9|\u95ee\u9898)|(?:\u8bc1\u636e|\u8bf4\u6cd5|\u53cd\u5bf9|\u6211\u6709).{0,18}\u5f02\u8bae/u.test(cleanSample);
    if (neutralLegalOrPoliticalContext && !/(?:\u8bc1\u636e|\u8bf4\u6cd5|\u95ee\u9898).{0,18}\u5f02\u8bae|\u5f02\u8bae.{0,18}(?:\u8bc1\u636e|\u8bf4\u6cd5|\u95ee\u9898)/u.test(cleanSample)) return true;
  ...
  if (term === '\u8001\u786c\u5e01' && family === 'attack') {
    const literalCoinContext = /(?:\u7ffb\u904d|\u5bb6\u91cc|\u786c\u5e01|\u8d27\u5e01|\u6536\u85cf|\u94dc\u5e01|\u7eaa\u5ff5\u5e01|\u8fd9\u4e9b).{0,16}\u8001\u786c\u5e01|\u8001\u786c\u5e01.{0,16}(?:\u5bb6\u91cc|\u8fd9\u4e9b|\u6536\u85cf|\u8d27\u5e01|\u786c\u5e01|\u94dc\u5e01|\u7eaa\u5ff5\u5e01)/u.test(cleanSample);
    const hostileSneakyContext = /(?:\u5bf9\u9762|\u5077\u88ad|\u9634|\u733f\u7410|\u53d8\u6210|\u8fd9\u4eba|\u8001\u516d|\u9634\u6bd4|\u9634\u9669).{0,18}\u8001\u786c\u5e01|\u8001\u786c\u5e01.{0,18}(?:\u5077\u88ad|\u9634|\u733f\u7410|\u8001\u516d|\u6253\u6cd5|\u4e1c\u897f)/u.test(cleanSample);
    return literalCoinContext && !hostileSneakyContext;
  }
  if (term === '\u540a\u6253' && family === 'attack') {
  ...
  if (term === '\u4ea1\u7075\u6cd5\u5e08' && family === 'attack') {
    const literalFantasyOrSourceContext = /(?:\u4f20\u5947|\u9632\u5fa1\u65d7|\u53ea\u60f3\u7528|\u8138\u6a21|\u58f0\u4f18|\u5eb7\u65af\u5766\u4e01|\u6765\u6e90\u4e4b\u4e00|\u539f\u56e0\u4e0d\u662f\u56e0\u4e3a|\u827e\u5f85).{0,36}\u4ea1\u7075\u6cd5\u5e08|\u4ea1\u7075\u6cd5\u5e08.{0,36}(?:\u4f20\u5947|\u9632\u5fa1\u65d7|\u53ea\u60f3\u7528|\u8138\u6a21|\u58f0\u4f18|\u5eb7\u65af\u5766\u4e01|\u6765\u6e90\u4e4b\u4e00|\u539f\u56e0\u4e0d\u662f\u56e0\u4e3a|\u827e\u5f85)/u.test(cleanSample);
    const resurrectionAttackContext = /(?:\u62db\u9b42|\u6316\u575f|\u7ffb\u65e7\u8d26|\u575f|\u70c2\u6897|\u8003\u53e4|\u8bc8\u5c38).{0,24}\u4ea1\u7075\u6cd5\u5e08|\u4ea1\u7075\u6cd5\u5e08.{0,24}(?:\u62db\u9b42|\u6316\u575f|\u7ffb\u65e7\u8d26|\u575f|\u70c2\u6897|\u8003\u53e4|\u8bc8\u5c38)/u.test(cleanSample);
    if (literalFantasyOrSourceContext && !resurrectionAttackContext) return true;
  }
  if (term === '\u65e0\u654c\u4e4b\u4eba' && family === 'attack') {
    const bareLabelContext = /^\u65e0\u654c\u4e4b\u4eba(?:[\s!！。？?\[\]\w\u4e00-\u9fa5_]*?)?$/u.test(cleanSample) && cleanSample.length <= 16;
    const positiveOrExplainerContext = /(?:\u4eba\u54c1\u5f88\u597d|\u6700\u5927\u7684\u5c0a\u91cd|\u66f4\u597d\u7684\u793e\u4f1a\u798f\u5229|\u516c\u5e73\u7684\u7ade\u4e89\u73af\u5883|\u5173\u5fc3\u4e0e\u5173\u7231|\u826f\u5fc3\u53d1\u73b0).{0,48}\u65e0\u654c\u4e4b\u4eba|\u65e0\u654c\u4e4b\u4eba.{0,48}(?:\u4eba\u54c1\u5f88\u597d|\u6700\u5927\u7684\u5c0a\u91cd|\u66f4\u597d\u7684\u793e\u4f1a\u798f\u5229|\u516c\u5e73\u7684\u7ade\u4e89\u73af\u5883|\u5173\u5fc3\u4e0e\u5173\u7231|\u826f\u5fc3\u53d1\u73b0)/u.test(cleanSample);
    const directedAttackContext = /(?:\u4f60\u662f|\u8c01\u8ddf\u4f60|\u4eba\u4e0d\u8981\u8138|\u5a01\u80c1|\u60f9\u4e0d\u8d77|\u5149\u811a|\u5e95\u7ebf).{0,24}\u65e0\u654c\u4e4b\u4eba|\u65e0\u654c\u4e4b\u4eba.{0,24}(?:\u4f60\u662f|\u8c01\u8ddf\u4f60|\u4eba\u4e0d\u8981\u8138|\u5a01\u80c1|\u60f9\u4e0d\u8d77|\u5149\u811a|\u5e95\u7ebf)/u.test(cleanSample);
    if ((bareLabelContext || positiveOrExplainerContext) && !directedAttackContext) return true;
  }
  if (term === '\u53d1\u56fe' && family === 'evidence') {
    ...
    const censorshipWorkaroundContext = /(?:\u6015\u88ab\u5220\u8bc4|\u6545\u53d1\u56fe|\u5220\u8bc4.{0,12}\u53d1\u56fe|\u53d1\u56fe.{0,12}\u5220\u8bc4)/u.test(cleanSample);
    return (existingImageReferenceContext || genericAnticipationContext || censorshipWorkaroundContext) && !requestImageContext;
  }
  ...
  if (['\u4e09\u963f\u54e5', '\u7687\u4e0a', '\u8001\u56db'].includes(term) && family === 'attack') {
    const palaceDramaContext = /(?:\u96cd\u6b63|\u5eb7\u7199|\u4e7e\u9686|\u5f18\u65f6|\u5f18\u5386|\u80e4\u7965|\u80e4\u793d|(?<![\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d\u5341])\u963f\u54e5|(?<![\u7687\u592a\u8001])\u7687\u4e0a|\u526a\u79cb|\u7504\u5b1b\u4f20|\u5bab\u6597|\u7acb\u50a8|\u4f20\u4f4d|\u7ee7\u627f\u4eba|\u5e9f\u592a\u5b50)/u.test(cleanSample);
  ...
  if (term === '\u4e09\u89d2\u8d38\u6613' && family === 'cooperation') {
    const literalHistoryContext = /(?:\u5386\u53f2|\u8d38\u6613\u8def\u7ebf|\u975e\u6d32|\u90e8\u843d|\u9ed1\u5974|\u6b96\u6c11|\u5927\u897f\u6d0b|\u8d29\u5356|\u4e70\u5356|\u5012\u5356)/u.test(cleanSample);
    const looseMetaMemeContext = /(?:\u8d5b\u535a\u4e09\u89d2\u8d38\u6613|\u4ec0\u4e48.*\u4e09\u89d2\u8d38\u6613)/u.test(cleanSample);
    const memeTradeContext = /\u4e09\u89d2\u8d38\u6613(?:[\uff0c,]?\u542f\u52a8|[\u7b11\u54eddoge]*\u6740)/u.test(cleanSample);
    const cooperativeExchangeContext = /(?:\u4e92\u6362|\u4ea4\u6362\u8d44\u6599|\u4f60\u7ed9\u6211|\u6211\u7ed9\u4f60|\u5408\u4f5c|\u4e92\u76f8\u63d0\u4f9b)/u.test(cleanSample);
    return (literalHistoryContext || looseMetaMemeContext) && !memeTradeContext && !cooperativeExchangeContext;
  }
...
export async function getDeepSeekConfig(options = {}) {
  ...
  const configuredModel = env.DEEPSEEK_MODEL || MODELS.V4_PRO;
...
async function requestDeepSeekKeywords(config, fetchImpl, options, body) {
  ...
  if (!response.ok) {
    ...
    throw new Error(`DeepSeek generate failed with HTTP ${response.status}: ${errorBody.slice(0, 200)}`);
  }
...
- Treat emoji and Bilibili bracket emotes as part of the sentence tone, not decoration. Markers such as [doge], [tv_doge], [doge_金箍], [藏狐], [滑稽], [妙啊], [吃瓜], [笑哭], 🙃, 😅, 😂, and 🤦 often carry sarcasm, satire, face-saving joking, mockery, or onlooker stance in Chinese online language.
- Do not classify an emoji by itself as proof of hostility. Explain whether the emote softens the sentence, signals satire, amplifies ridicule, or makes the speaker avoid direct commitment.
...
- Treat emoji and Bilibili bracket emotes as semantic tone markers. [doge], [tv_doge], [doge_金箍], [藏狐], [滑稽], [妙啊], [吃瓜], [笑哭], 🙃, 😅, 😂, and 🤦 can signal sarcasm, satire, face-saving joking, mockery, or onlooker stance in Chinese online language.
- Do not treat an emoji alone as sufficient hostility; explain whether it softens, satirizes, amplifies ridicule, or avoids direct commitment.
