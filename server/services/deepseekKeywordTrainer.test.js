...
test('normalizes Bilibili emote wrapper artifacts to the spoken keyword', () => {
  ...
  assert.deepEqual(entries.map((entry) => entry.term), ['\u61c2\u4e86\u5427']);
});
...
test('findDictionaryEntriesWithTextEvidence rejects literal game-mode and self-emotion evidence', () => {
  ...
  assert.deepEqual(entries.map((entry) => entry.term), ['\u9e21\u8d3c', '\u6025\u6b7b\u4e86', '\u96c6\u7f8e']);
  assert.equal(entries[0].evidenceCount, 1);
  assert.deepEqual(entries[0].evidenceSamples, ['\u4ed6\u8fd9\u4e2a\u5403\u76f8\u592a\u9e21\u8d3c\u4e86\uff0c\u5c31\u662f\u60f3\u5360\u4fbf\u5b9c']);
  assert.equal(entries[1].evidenceCount, 1);
  assert.deepEqual(entries[1].evidenceSamples, ['\u5546\u4eba\u6025\u6b7b\u4e86\uff0c\u68a6\u5e7b\u5012\u4e0d\u5012\u8ddf\u4f60\u4e00\u4e2a\u533a\u7684\u5978\u5546\u6709\u5565\u5173\u7cfb']);
  assert.equal(entries[2].evidenceCount, 1);
  assert.deepEqual(entries[2].evidenceSamples, ['\u5982\u679c\u96c6\u7f8e\u4eec\u771f\u7684\u548c\u5979\u8bf4\u7684\u4e00\u6837\uff0c\u4e0d\u73a9\u4e86\uff0c\u8fd9\u53cd\u800c\u4e0d\u662f\u4ef6\u597d\u4e8b\u5417\uff1f']);
});
...
test('findDictionaryEntriesWithTextEvidence rejects harvested comeback, username, and standalone praise evidence', () => {
  ...
  assert.deepEqual(realEntries.map((entry) => entry.term), ['\u5931\u8e2a\u4eba\u53e3']);
});
...
test('findDictionaryEntriesWithTextEvidence rejects literal expression-definition evidence for attack terms', () => {
  ...
  const text = [
    ...
    '\u597d\u770b\u7684\u8138\u662f\u963f\u9ed1\u989c\uff0c\u957f\u76f8\u4e00\u822c\u7684\u666e\u901a\u4eba\u505a\u8fd9\u4e2a\u8868\u60c5\u5f88\u4e11\u7684\uff0c\u8ddf\u9b3c\u8138\u4e00\u6837[\u7b11\u54ed]',
    '\u963f\u9ed1\u989c\u5565\u610f\u601d',
  ].join('\n');
...
test('findDictionaryEntriesWithTextEvidence rejects apology reactions, standalone emotes, and bare bug labels', () => {
  ...
  assert.deepEqual(realEntries.map((entry) => entry.term), ['\u5bf9\u4e0d\u8d77', '\u65e0\u8bed', '\u5361bug']);
});
...
test('normalizeKeywordEntries prunes latest harvested medical, game, and generic cooperation evidence', () => {
  const entries = normalizeKeywordEntries([
    ...
    },
    {
      term: '\u5bab\u9888\u7cdc\u70c2',
      family: 'correction',
      meaning: 'corrects inaccurate medical wording or weakens an earlier claim',
      evidenceCount: 3,
      evidenceSamples: [
        '\u6211\u4e5f\u88ab\u9a97\u8fc7\uff0c\u533b\u751f\u7279\u522b\u4e25\u8083\u7684\u8ddf\u6211\u8bf4\u201c\u4f60\u8fd9\u662f\u5bab\u9888\u7cdc\u70c2\u554a\uff0c\u4ee5\u540e\u4e25\u91cd\u4e86\u8981\u764c\u53d8\u7684\u201d\uff0c\u8ba9\u6211\u505a\u624b\u672f',
        '\u533b\u751f\u4e5f\u6709\u4e1a\u7ee9\u5417\uff1f\u4e3a\u4ec0\u4e48\u6211\u4eec\u8fd9\u5927\u533b\u9662\u7684\u533b\u751f\u4e5f\u7528\u5bab\u9888\u7cdc\u70c2\u5413\u552c\u522b\u4eba',
        '\u4f53\u68c0\u533b\u751f\u8bf4\u4f60\u5bab\u9888\u7cdc\u70c2\u4f60\u81ea\u5df1\u77e5\u9053\u5417\uff0c\u53c8\u8ba9\u6211\u4ea4\u94b1\u68c0\u67e5',
        '\u5bab\u9888\u7cdc\u70c2\u8fd9\u4e2a\u8bf4\u6cd5\u65e9\u5c31\u8be5\u66f4\u6b63\u4e86\uff0c\u4e0d\u662f\u4f60\u4e4b\u524d\u8bf4\u7684\u90a3\u79cd\u75c5',
      ],
      evidenceSources: [
        { source: 'Bilibili public video comment scan', sample: '\u6211\u4e5f\u88ab\u9a97\u8fc7\uff0c\u533b\u751f\u7279\u522b\u4e25\u8083\u7684\u8ddf\u6211\u8bf4\u201c\u4f60\u8fd9\u662f\u5bab\u9888\u7cdc\u70c2\u554a\uff0c\u4ee5\u540e\u4e25\u91cd\u4e86\u8981\u764c\u53d8\u7684\u201d\uff0c\u8ba9\u6211\u505a\u624b\u672f' },
        { source: 'Bilibili public video comment scan', sample: '\u533b\u751f\u4e5f\u6709\u4e1a\u7ee9\u5417\uff1f\u4e3a\u4ec0\u4e48\u6211\u4eec\u8fd9\u5927\u533b\u9662\u7684\u533b\u751f\u4e5f\u7528\u5bab\u9888\u7cdc\u70c2\u5413\u552c\u522b\u4eba' },
        { source: 'Bilibili public video comment scan', sample: '\u4f53\u68c0\u533b\u751f\u8bf4\u4f60\u5bab\u9888\u7cdc\u70c2\u4f60\u81ea\u5df1\u77e5\u9053\u5417\uff0c\u53c8\u8ba9\u6211\u4ea4\u94b1\u68c0\u67e5' },
        { source: 'Bilibili public video comment scan', sample: '\u5bab\u9888\u7cdc\u70c2\u8fd9\u4e2a\u8bf4\u6cd5\u65e9\u5c31\u8be5\u66f4\u6b63\u4e86\uff0c\u4e0d\u662f\u4f60\u4e4b\u524d\u8bf4\u7684\u90a3\u79cd\u75c5' },
      ],
    },
    {
      term: '\u53f7\u88ab\u76d7\u4e86',
  ...
  const entries = normalizeKeywordEntries([
    ...
    },
    {
      ...
      evidenceSamples: [
        ...
        '\u78a7\u84dd\u822a\u7ebf \u840c\u65b0\u6307\u5357\u653b\u7565 \u4e3b\u7ebf1-1\u5feb\u901f\u4f4e\u8017\u6cb9\u5237\u597d\u611f\u5ea6',
        '\u3010\u539f\u795e\u3011\u6700\u901f\u5237\u597d\u611f\u65b9\u6848\uff015\u5206\u949f=1W\u6469\u62c9+150\u597d\u611f\u5ea6\uff01',
        '\u8fd8\u662f\u611f\u89c9\u5728\u5237\u597d\u611f[\u5403\u74dc]',
      ],
      evidenceSources: [],
    },
    {
      term: '\u786c\u64e6',
      family: 'attack',
      meaning: 'accuses someone of forcing a weak explanation',
      evidenceCount: 3,
      evidenceSamples: [
        '\u770b\u7684\u6211\u7b11\u51fa\u58f0\uff0c\u4e0d\u4f1a\u64e6\u786c\u64e6\u54c8\u54c8\u54c8[\u5403\u74dc]',
        '\u8bf7\u95ee\u63a8\u5149\u6f06\u548c\u786c\u64e6\u6f06\u76f8\u5bf9\u800c\u8a00\u662f\u4e0d\u662f\u66f4\u5bb9\u6613\u7559\u4e0b\u957f\u65f6\u95f4\u5f39\u7434\u540e\u7559\u4e0b\u5f26\u8def\u5462\uff1f\u4e5f\u5c31\u662f\u8bf4\u786c\u64e6\u6f06\u66f4\u8010\u78e8\uff1f',
        '\u63a8\u5149\u6f06\u7434\u5927\u90e8\u5206\u505a\u7684\u662f\u955c\u9762\u6548\u679c\uff0c\u56e0\u6b64\u6709\u5212\u75d5\u66f4\u4e3a\u660e\u663e\uff0c\u4f46\u786c\u64e6\u6f06\u4e5f\u4e0d\u662f\u4e00\u70b9\u6ca1\u6709\uff0c\u53ea\u662f\u76f8\u5bf9\u6765\u8bf4\u54d1\u5149\u6548\u679c\u4e0b\uff0c\u8089\u773c\u4e0d\u89c9\u5f97\u5f88\u660e\u663e',
      ],
      evidenceSources: [],
    },
    {
...
test('normalizeKeywordEntries prunes bare labels and literal academic examples for attack terms', () => {
  const entries = normalizeKeywordEntries([
    ...
    },
    {
      ...
      evidenceSamples: [
        ...
        '\u96be\u5012\u4e0d\u662f\u5148\u9009\u597d\u53c2\u8003\u6587\u732epdf\u90fd\u6254\u7ed9\u5b83\uff0c\u95ee\u9898\u4e0d\u5c31\u8fce\u96be\u800c\u89e3\u4e86\u5417\uff1f',
        '\u53ef\u4ee5\u7528grok\u627e\u53c2\u8003\u6587\u732e',
        '\u5bf9\uff0cgrok\u592a\u66b4\u529b\u4e86\uff0c\u597d\u591a\u5e93\u90fd\u80fd\u8fdb\u53bb\u62ff\uff0c\u4ed6\u7ed9\u6211\u627e\u7684\u53c2\u8003\u6587\u732e\u90fd\u662f\u771f\u7684',
        '\u8fd9\u4e0d\u6284\u7684\u5417\uff0c\u53c2\u8003\u6587\u732e\u90fd\u4e0d\u653e',
      ],
      evidenceSources: [
        ...
        { source: 'Bilibili public video comment scan', sample: '\u96be\u5012\u4e0d\u662f\u5148\u9009\u597d\u53c2\u8003\u6587\u732epdf\u90fd\u6254\u7ed9\u5b83\uff0c\u95ee\u9898\u4e0d\u5c31\u8fce\u96be\u800c\u89e3\u4e86\u5417\uff1f' },
        { source: 'Bilibili public video comment scan', sample: '\u53ef\u4ee5\u7528grok\u627e\u53c2\u8003\u6587\u732e' },
        { source: 'Bilibili public video comment scan', sample: '\u5bf9\uff0cgrok\u592a\u66b4\u529b\u4e86\uff0c\u597d\u591a\u5e93\u90fd\u80fd\u8fdb\u53bb\u62ff\uff0c\u4ed6\u7ed9\u6211\u627e\u7684\u53c2\u8003\u6587\u732e\u90fd\u662f\u771f\u7684' },
  ...
  assert.deepEqual(byTerm['\u53c2\u8003\u6587\u732e'].evidenceSources.map((source) => source.sample), ['\u8fd9\u4e0d\u6284\u7684\u5417\uff0c\u53c2\u8003\u6587\u732e\u90fd\u4e0d\u653e']);
  ...
  const entries = normalizeKeywordEntries([
    ...
    },
    {
      ...
      evidenceSources: [
        ...
        { source: 'Bilibili public video comment scan', sample: '\u770b\u6210 \u9ad8\u96c4\u4f20\u5bb6\u5b9d \u4e86' },
  ...
  const entries = normalizeKeywordEntries([
    {
      ...
      evidenceSamples: [
        ...
        '\u5eb7\u5fb7\u5e2e\u52a9\u6211\u4eec\u6446\u8131\u5bfb\u6c42\u7edd\u5bf9\u6b63\u786e\u7684\u5984\u5ff5',
        '\u8fd9\u53e5\u8bdd\u672c\u8eab\uff0c\u5c31\u662f\u4e2a\u6096\u8bba\u3002\u6240\u4ee5\u552f\u4e00\u6b63\u786e\u7684\u903b\u8f91\u662f\uff0c\u4e16\u754c\u4e0a\u6709\u7edd\u5bf9\u6b63\u786e\u7684\u4e8b\u60c5\u3002[doge]',
      ],
      evidenceSources: [
        ...
        { source: 'Bilibili public video comment scan', sample: '\u8fd9\u53e5\u8bdd\u672c\u8eab\uff0c\u5c31\u662f\u4e2a\u6096\u8bba\u3002\u6240\u4ee5\u552f\u4e00\u6b63\u786e\u7684\u903b\u8f91\u662f\uff0c\u4e16\u754c\u4e0a\u6709\u7edd\u5bf9\u6b63\u786e\u7684\u4e8b\u60c5\u3002[doge]' },
      ],
    },
  ]);
...
test('normalizeKeywordEntries prunes latest harvested username and literal coin evidence', () => {
  const entries = normalizeKeywordEntries([
    {
      term: '\u5764\u5df4',
      family: 'attack',
      meaning: '\u2018\u51e0\u628a\u2019\u7684\u8c10\u97f3\u7c97\u53e3\uff0c\u7528\u4e8e\u8868\u8fbe\u5f3a\u70c8\u4e0d\u6ee1\u6216\u8d2c\u4f4e',
      evidenceCount: 4,
      evidenceSamples: [
        '\u8fd9\u4eba\u7d20\u8d28\u771f\u5764\u5df4\u5dee',
        '\u8fd9\u4e2a\u89c6\u9891\u80af\u5b9a\u88ab\u4e0b\u67b6\u8fc7\uff0c\u6807\u9898\u88ab\u8feb\u6539\u6210\u4e86\u5764\u5df4',
        '@\u5764\u5df4',
        '\u5728\u5f88\u4e45\u4ee5\u524d\uff0c\u5728\u5764\u5427\u8fd9\u4e2a\u8bcd\u8fd8\u6ca1\u666e\u53ca\uff0c\u751a\u81f3\u5f53\u65f6\u4ee5\u4e3a\u8fd9\u662f\u81ea\u5df1\u81ea\u521b\u7684\u72ec\u95e8\u8bcd\u65f6\uff0c\u6211\u7684\u6240\u6709\u6e38\u620fID\u90fd\u53eb"\u4e00\u4e2a\u5927\u5764\u5df4"[\u7b11\u54ed][\u7b11\u54ed]',
      ],
      evidenceSources: [
        { source: 'Bilibili public video comment scan', sample: '\u8fd9\u4eba\u7d20\u8d28\u771f\u5764\u5df4\u5dee' },
        { source: 'Bilibili public video comment scan', sample: '\u8fd9\u4e2a\u89c6\u9891\u80af\u5b9a\u88ab\u4e0b\u67b6\u8fc7\uff0c\u6807\u9898\u88ab\u8feb\u6539\u6210\u4e86\u5764\u5df4' },
        { source: 'Bilibili public video comment scan', sample: '@\u5764\u5df4' },
        { source: 'Bilibili public video comment scan', sample: '\u5728\u5f88\u4e45\u4ee5\u524d\uff0c\u5728\u5764\u5427\u8fd9\u4e2a\u8bcd\u8fd8\u6ca1\u666e\u53ca\uff0c\u751a\u81f3\u5f53\u65f6\u4ee5\u4e3a\u8fd9\u662f\u81ea\u5df1\u81ea\u521b\u7684\u72ec\u95e8\u8bcd\u65f6\uff0c\u6211\u7684\u6240\u6709\u6e38\u620fID\u90fd\u53eb"\u4e00\u4e2a\u5927\u5764\u5df4"[\u7b11\u54ed][\u7b11\u54ed]' },
      ],
    },
    {
      term: '\u8001\u786c\u5e01',
      family: 'attack',
      meaning: '\u7f51\u7edc\u8c10\u97f3\u6897\uff0c\u6307\u2018\u8001\u9634\u6bd4\u2019\uff08\u9634\u9669\u72e1\u8bc8\u7684\u4eba\uff09\uff0c\u5e26\u6709\u5632\u8bbd\u548c\u4fae\u8fb1\u610f\u5473',
      evidenceCount: 3,
      evidenceSamples: [
        '\u6ca1\u60f3\u5230\u5bf9\u9762\u8001\u786c\u5e01\u52a0\u5077\u88ad\uff0c\u8fd8\u6709\u592a\u9634\u4e86\u3002\u8fd9\u51e0\u4e2a\u4e00\u770b\u5c31\u662f\u6ca1\u89c1\u8fc7\u8fd9\u60c5\u51b5\uff0c\u76f4\u63a5\u88ab\u5927\u6b8b\u8840\u7684\u7384\u9aa8\u7ed9\u5077\u88ad\u5676\u4e86',
        '\u53d8\u6210\u8001\u786c\u5e01\u4e86',
        '\u7ffb\u904d\u4e86\u5bb6\u91cc\u7684\u8001\u786c\u5e01\uff0c\u5c31\u8fd9\u4e9b',
      ],
      evidenceSources: [
        { source: 'Bilibili public video comment scan', sample: '\u6ca1\u60f3\u5230\u5bf9\u9762\u8001\u786c\u5e01\u52a0\u5077\u88ad\uff0c\u8fd8\u6709\u592a\u9634\u4e86\u3002\u8fd9\u51e0\u4e2a\u4e00\u770b\u5c31\u662f\u6ca1\u89c1\u8fc7\u8fd9\u60c5\u51b5\uff0c\u76f4\u63a5\u88ab\u5927\u6b8b\u8840\u7684\u7384\u9aa8\u7ed9\u5077\u88ad\u5676\u4e86' },
        { source: 'Bilibili public video comment scan', sample: '\u53d8\u6210\u8001\u786c\u5e01\u4e86' },
        { source: 'Bilibili public video comment scan', sample: '\u7ffb\u904d\u4e86\u5bb6\u91cc\u7684\u8001\u786c\u5e01\uff0c\u5c31\u8fd9\u4e9b' },
      ],
    },
  ]);

  assert.deepEqual(entries.find((entry) => entry.term === '\u5764\u5df4').evidenceSamples, ['\u8fd9\u4eba\u7d20\u8d28\u771f\u5764\u5df4\u5dee']);
  assert.deepEqual(entries.find((entry) => entry.term === '\u8001\u786c\u5e01').evidenceSamples, [
    '\u6ca1\u60f3\u5230\u5bf9\u9762\u8001\u786c\u5e01\u52a0\u5077\u88ad\uff0c\u8fd8\u6709\u592a\u9634\u4e86\u3002\u8fd9\u51e0\u4e2a\u4e00\u770b\u5c31\u662f\u6ca1\u89c1\u8fc7\u8fd9\u60c5\u51b5\uff0c\u76f4\u63a5\u88ab\u5927\u6b8b\u8840\u7684\u7384\u9aa8\u7ed9\u5077\u88ad\u5676\u4e86',
    '\u53d8\u6210\u8001\u786c\u5e01\u4e86',
  ]);
});

test('normalizeKeywordEntries prunes latest harvested literal study and generic greatness evidence', () => {
  const entries = normalizeKeywordEntries([
    {
      term: '\u5b66\u4e60\u4e86',
      family: 'cooperation',
      meaning: '\u201c\u5b66\u4e60\u4e86\u201d\u7528\u4e8e\u8868\u793a\u652f\u6301\u3001\u8865\u5145\u3001\u8f7b\u677e\u4e92\u52a8\u6216\u5408\u4f5c\u5f0f\u8ba8\u8bba',
      evidenceCount: 3,
      evidenceSamples: [
        '\u8c22\u8c22\uff01\u5b66\u4e60\u4e86\uff0c\u4e0b\u4e00\u5957\u623f\u5c31\u6309\u7167\u4f60\u8bf4\u7684\u65b9\u5f0f\u6765',
        '\u6765\u5b66\u4e60\u4e86\uff01',
        '\u6211\u8bfb\u4e86\u516d\u4e03\u90e8\u5730\u85cf\u7ecf\uff0c\u73b0\u5728\u6bcf\u5929\u5ff5\u9001\u89c9\u6797\u83e9\u8428\u8bb0\uff0c\u548c\u5730\u85cf\u7ecf\u540e\u4e24\u54c1\uff0c\u8fd8\u6709\u4e00\u5343\u58f0\u5730\u85cf\u83e9\u8428\u5723\u53f7\uff0c\u5230\u73b0\u5728\u6211\u5df2\u575a\u630140\u591a\u5929\u4e86\uff0c\u6211\u59d1\u5a18\u4e03\u5c81\u4e00\u5e74\u7ea7\uff0c\u4e4b\u524d\u4e0d\u7231\u8bfb\u4e66\uff0c\u4e0d\u7231\u5b66\u4e60\uff0c\u524d\u4e24\u5929\u7a81\u7136\u5bf9\u6211\u8bf4\uff0c\u7238\u7238\u6211\u89c9\u5f97\u5b66\u4e60\u4e5f\u633a\u597d\u73a9\u7684\uff0c\u4e4b\u524d\u662f\u6211\u4e0d\u600e\u4e48\u559c\u6b22\u5b66\u4e60\uff0c\u6240\u4ee5\u6211\u6210\u7ee9\u4e0d\u597d\uff0c\u4e0d\u662f...',
      ],
      evidenceSources: [
        { source: 'Bilibili public video comment scan', sample: '\u8c22\u8c22\uff01\u5b66\u4e60\u4e86\uff0c\u4e0b\u4e00\u5957\u623f\u5c31\u6309\u7167\u4f60\u8bf4\u7684\u65b9\u5f0f\u6765' },
        { source: 'Bilibili public video comment scan', sample: '\u6765\u5b66\u4e60\u4e86\uff01' },
        { source: 'Bilibili public video comment scan', sample: '\u6211\u8bfb\u4e86\u516d\u4e03\u90e8\u5730\u85cf\u7ecf\uff0c\u73b0\u5728\u6bcf\u5929\u5ff5\u9001\u89c9\u6797\u83e9\u8428\u8bb0\uff0c\u548c\u5730\u85cf\u7ecf\u540e\u4e24\u54c1\uff0c\u8fd8\u6709\u4e00\u5343\u58f0\u5730\u85cf\u83e9\u8428\u5723\u53f7\uff0c\u5230\u73b0\u5728\u6211\u5df2\u575a\u630140\u591a\u5929\u4e86\uff0c\u6211\u59d1\u5a18\u4e03\u5c81\u4e00\u5e74\u7ea7\uff0c\u4e4b\u524d\u4e0d\u7231\u8bfb\u4e66\uff0c\u4e0d\u7231\u5b66\u4e60\uff0c\u524d\u4e24\u5929\u7a81\u7136\u5bf9\u6211\u8bf4\uff0c\u7238\u7238\u6211\u89c9\u5f97\u5b66\u4e60\u4e5f\u633a\u597d\u73a9\u7684\uff0c\u4e4b\u524d\u662f\u6211\u4e0d\u600e\u4e48\u559c\u6b22\u5b66\u4e60\uff0c\u6240\u4ee5\u6211\u6210\u7ee9\u4e0d\u597d\uff0c\u4e0d\u662f...' },
      ],
    },
    {
      term: '\u7f57\u795e\u4f1f\u5927',
      family: 'absolutes',
      meaning: '\u7edd\u5bf9\u5316\u8d5e\u7f8e\u89d2\u8272\u6216\u4eba\u7269\uff0c\u8868\u8fbe\u65e0\u6761\u4ef6\u5d07\u62dc',
      evidenceCount: 2,
      evidenceSamples: [
        '\u7f57\u795e\u4f1f\u5927\uff0c\u65e0\u9700\u591a\u8a00\u3002',
        '\u6211\u73b0\u5728\u770b\u5230\u4f1f\u5927\u65e0\u9700\u591a\u8a00\u7684\u65f6\u5019\u60f3\u5230\u7684\u662f\u55bb\u6587\u6ce2\u7684\u6027\u683c\u662f\u771f\u7684\u725b\u6279',
      ],
      evidenceSources: [
        { source: 'Bilibili public video comment scan', sample: '\u7f57\u795e\u4f1f\u5927\uff0c\u65e0\u9700\u591a\u8a00\u3002' },
        { source: 'Bilibili public video comment scan', sample: '\u6211\u73b0\u5728\u770b\u5230\u4f1f\u5927\u65e0\u9700\u591a\u8a00\u7684\u65f6\u5019\u60f3\u5230\u7684\u662f\u55bb\u6587\u6ce2\u7684\u6027\u683c\u662f\u771f\u7684\u725b\u6279' },
      ],
    },
  ]);

  assert.deepEqual(entries.find((entry) => entry.term === '\u5b66\u4e60\u4e86').evidenceSamples, [
    '\u8c22\u8c22\uff01\u5b66\u4e60\u4e86\uff0c\u4e0b\u4e00\u5957\u623f\u5c31\u6309\u7167\u4f60\u8bf4\u7684\u65b9\u5f0f\u6765',
    '\u6765\u5b66\u4e60\u4e86\uff01',
  ]);
  assert.equal(entries.find((entry) => entry.term === '\u7f57\u795e\u4f1f\u5927'), undefined);
});

test('normalizeKeywordEntries prunes latest harvested fandom explanation and celebrity-name evidence', () => {
  const entries = normalizeKeywordEntries([
    {
      term: '\u8499\u9f13\u4eba',
      family: 'cooperation',
      meaning: '\u201c\u8499\u9f13\u4eba\u201d\u7528\u4e8e\u8868\u793a\u652f\u6301\u3001\u8865\u5145\u3001\u8f7b\u677e\u4e92\u52a8\u6216\u5408\u4f5c\u5f0f\u8ba8\u8bba',
      evidenceCount: 3,
      evidenceSamples: [
        '\u8c22\u8c22\u4f60\u8499\u9f13\u4eba\uff0c\u6240\u4ee5\u9e3d\u5b50\u4e3a\u4ec0\u4e48\u8fd9\u4e48\u5927[doge]',
        '\u8fd9\u4e2aUP\u4e3b\u5728\u89e3\u91ca\u4ec0\u4e48\u53eb\u201c\u8499\u9f13\u4eba\u201d\u7684\u6897',
        '\u5982:\u8fd9\u4e2a\u89c6\u9891\u662f\u5728\u8bb2\u8499\u9f13\u4eba\u800c\u4e0d\u662f\u8499\u53e4\u4eba',
      ],
      evidenceSources: [
        { source: 'Bilibili public video comment scan', sample: '\u8c22\u8c22\u4f60\u8499\u9f13\u4eba\uff0c\u6240\u4ee5\u9e3d\u5b50\u4e3a\u4ec0\u4e48\u8fd9\u4e48\u5927[doge]' },
        { source: 'Bilibili public video comment scan', sample: '\u8fd9\u4e2aUP\u4e3b\u5728\u89e3\u91ca\u4ec0\u4e48\u53eb\u201c\u8499\u9f13\u4eba\u201d\u7684\u6897' },
        { source: 'Bilibili public video comment scan', sample: '\u5982:\u8fd9\u4e2a\u89c6\u9891\u662f\u5728\u8bb2\u8499\u9f13\u4eba\u800c\u4e0d\u662f\u8499\u53e4\u4eba' },
      ],
    },
    {
      term: '\u68a6\u7537',
      family: 'attack',
      meaning: '\u6307\u5bf9\u7279\u5b9aUP\u4e3b\u6216\u89d2\u8272\u4ea7\u751f\u8fc7\u5ea6\u5d07\u62dc\u3001\u5e7b\u60f3\u7684\u4eba\uff0c\u5e38\u5e26\u6709\u5632\u8bbd\u63a7\u8bc4\u6216\u8fc7\u5ea6\u8ffd\u6367\u7684\u610f\u5473',
      evidenceCount: 4,
      evidenceSamples: [
        '\u5999\u754c\u68a6\u7537\u9093\u80af\uff0c\u5999\u754c\u68a6\u5973\u72f8\u72f8',
        '\u770b\u4e86\u4f60\u7684\u6295\u7a3f\uff0c\u6211\u4e5f\u662f\u6e05\u6e05\u68a6\u7537[\u7b11\u54ed]',
      ...
      evidenceSources: [
        { source: 'Bilibili public video comment scan', sample: '\u5999\u754c\u68a6\u7537\u9093\u80af\uff0c\u5999\u754c\u68a6\u5973\u72f8\u72f8' },
        { source: 'Bilibili public video comment scan', sample: '\u770b\u4e86\u4f60\u7684\u6295\u7a3f\uff0c\u6211\u4e5f\u662f\u6e05\u6e05\u68a6\u7537[\u7b11\u54ed]' },
        { source: 'Bilibili public video comment scan', sample: '\u68a6\u7537\u8fd8\u55d1cp\u7684\u5417' },
        { source: 'Bilibili public video comment scan', sample: '\u54c8\u54c8\u54c8\u54c8\u54c8\u6211\u4e0d\u884c\u4e86\u4e0d\u6127\u662f\u68a6\u7537' },
      ],
    },
    {
      term: '\u60a8\u914d\u5417',
      family: 'attack',
      meaning: '\u53cd\u95ee\u5bf9\u65b9\u662f\u5426\u5177\u5907\u8d44\u683c\uff0c\u5e38\u7528\u4e8e\u5632\u8bbd\u548c\u5c45\u9ad8\u4e34\u4e0b\u7684\u8d28\u7591',
      evidenceCount: 2,
      evidenceSamples: [
        '\u4e0d\u5c31\u662f\u4e3a\u4e86\u5229\u76ca\u505a\u4e8b\uff0c\u6709\u4e9b\u4eba\u771f\u5f53\u81ea\u5df1\u662f\u5723\u4eba\u554a\uff0c\u8fd8\u62ef\u6551\u4e16\u754c\uff0c\u7ed9\u7237\u722c\u3002\u4f60\u4e0d\u8981\u5f53\u8fd9\u4e2a\u597d\u4eba\u4e86\uff0c\u6211\u7ed9\u4f6010\u4e07\uff0c100\u4e07\uff0c1000\u4e07\uff0c\u884c\u4e0d\u884c\uff1f\u8fd9\u4e16\u754c\u597d\u4eba\u53ef\u4e0d\u591a\uff0c\u8fd9\u79cd\u4e00\u6293\u4e00\u5927\u628a\uff0c\u8fd8\u771f\u628a\u81ea\u5df1\u5f53\u96f7\u950b\uff0c\u60a8\u914d\u5417\uff1f',
        '\u836f\u6c34\u54e5\u5c31\u662f\u56e0\u4e3a\u201c\u60a8\u914d\u5417\u201d\u4e00\u4e0b\u706b\u8d77\u6765\u7684\uff0c\u6211\u4e5f\u662f\u56e0\u4e3a\u8fd9\u4e2a\u77e5\u9053\u836f\u6c34\u54e5\u7684',
      ],
      evidenceSources: [
        { source: 'Bilibili public video comment scan', sample: '\u4e0d\u5c31\u662f\u4e3a\u4e86\u5229\u76ca\u505a\u4e8b\uff0c\u6709\u4e9b\u4eba\u771f\u5f53\u81ea\u5df1\u662f\u5723\u4eba\u554a\uff0c\u8fd8\u62ef\u6551\u4e16\u754c\uff0c\u7ed9\u7237\u722c\u3002\u4f60\u4e0d\u8981\u5f53\u8fd9\u4e2a\u597d\u4eba\u4e86\uff0c\u6211\u7ed9\u4f6010\u4e07\uff0c100\u4e07\uff0c1000\u4e07\uff0c\u884c\u4e0d\u884c\uff1f\u8fd9\u4e16\u754c\u597d\u4eba\u53ef\u4e0d\u591a\uff0c\u8fd9\u79cd\u4e00\u6293\u4e00\u5927\u628a\uff0c\u8fd8\u771f\u628a\u81ea\u5df1\u5f53\u96f7\u950b\uff0c\u60a8\u914d\u5417\uff1f' },
        { source: 'Bilibili public video comment scan', sample: '\u836f\u6c34\u54e5\u5c31\u662f\u56e0\u4e3a\u201c\u60a8\u914d\u5417\u201d\u4e00\u4e0b\u706b\u8d77\u6765\u7684\uff0c\u6211\u4e5f\u662f\u56e0\u4e3a\u8fd9\u4e2a\u77e5\u9053\u836f\u6c34\u54e5\u7684' },
      ],
    },
    {
      term: '\u6b27\u9633\u5a1c\u5a1c',
      family: 'evidence',
      meaning: '\u201c\u6b27\u9633\u5a1c\u5a1c\u201d\u7528\u4e8e\u8bf7\u6c42\u3001\u8865\u5145\u6216\u6307\u5411\u53ef\u6838\u9a8c\u7684\u6765\u6e90\u3001\u8bc1\u636e\u6216\u539f\u59cb\u6750\u6599',
      evidenceCount: 2,
      evidenceSamples: [
        '\u6b27\u9633\u5a1c\u5a1c\u771f\u7684\u662f\u6709\u52aa\u529b\u53c8\u4f18\u79c0',
        '\u8fd9\u4e2a\u4eba\u5728ins\u5410\u69fd\u6b27\u9633\u5a1c\u5a1c\u8138\u5927\u3002',
      ...
      evidenceSources: [
        { source: 'Bilibili public video comment scan', sample: '\u6b27\u9633\u5a1c\u5a1c\u771f\u7684\u662f\u6709\u52aa\u529b\u53c8\u4f18\u79c0' },
        { source: 'Bilibili public video comment scan', sample: '\u8fd9\u4e2a\u4eba\u5728ins\u5410\u69fd\u6b27\u9633\u5a1c\u5a1c\u8138\u5927\u3002' },
      ],
    },
  ]);

  assert.deepEqual(entries.find((entry) => entry.term === '\u8499\u9f13\u4eba').evidenceSamples, ['\u8c22\u8c22\u4f60\u8499\u9f13\u4eba\uff0c\u6240\u4ee5\u9e3d\u5b50\u4e3a\u4ec0\u4e48\u8fd9\u4e48\u5927[doge]']);
  assert.deepEqual(entries.find((entry) => entry.term === '\u68a6\u7537').evidenceSamples, ['\u54c8\u54c8\u54c8\u54c8\u54c8\u6211\u4e0d\u884c\u4e86\u4e0d\u6127\u662f\u68a6\u7537']);
  assert.deepEqual(entries.find((entry) => entry.term === '\u60a8\u914d\u5417').evidenceSamples, [
    '\u4e0d\u5c31\u662f\u4e3a\u4e86\u5229\u76ca\u505a\u4e8b\uff0c\u6709\u4e9b\u4eba\u771f\u5f53\u81ea\u5df1\u662f\u5723\u4eba\u554a\uff0c\u8fd8\u62ef\u6551\u4e16\u754c\uff0c\u7ed9\u7237\u722c\u3002\u4f60\u4e0d\u8981\u5f53\u8fd9\u4e2a\u597d\u4eba\u4e86\uff0c\u6211\u7ed9\u4f6010\u4e07\uff0c100\u4e07\uff0c1000\u4e07\uff0c\u884c\u4e0d\u884c\uff1f\u8fd9\u4e16\u754c\u597d\u4eba\u53ef\u4e0d\u591a\uff0c\u8fd9\u79cd\u4e00\u6293\u4e00\u5927\u628a\uff0c\u8fd8\u771f\u628a\u81ea\u5df1\u5f53\u96f7\u950b\uff0c\u60a8\u914d\u5417\uff1f',
  ]);
  assert.equal(entries.some((entry) => entry.term === '\u6b27\u9633\u5a1c\u5a1c'), false);
});
...
test('normalizeKeywordEntries prunes latest harvested context-only evidence', () => {
  const entries = normalizeKeywordEntries([
    {
      term: '\u8d5b\u5bc4',
      family: 'attack',
      meaning: '\u7528\u4e8e\u5bf9\u6bd4\u8d5b\u6216\u6e38\u620f\u4f53\u9a8c\u7684\u8d1f\u9762\u8bc4\u4ef7',
      evidenceCount: 4,
      evidenceSamples: [
        '20w\u4e86\uff0c\u4e0d\u8fc7\u6211\u89c9\u5f97\u5149\u8bc4\u8bba\u5bf9\u8f70\u6ca1\u7528\u554a\uff0c\u8d5b\u5bc4\u90a3\u6b21\u5c31\u51fa\u8fc7\u7c7b\u4f3c\u7684\u4e8b\u4f46\u8fd8\u662f\u6ca1\u7528\uff0c\u5f97\u76f4\u63a5\u6253\u7968\u9000\u94b1\u5dee\u8bc4\u53cd\u9988\u4e3e\u62a5[\u8fa3\u773c\u775b]',
        '\u4e00\u5f00\u59cb\u54c8\u83ab\u8fd9\u79cd\u6218\u529b\u5728\u9694\u58c1\u542f\u822a\u6392\u7b2c\u51e0\u5341\u7684\u89d2\u8272\u5c45\u7136\u80fd\u5728\u8d5b\u5bc4\u5360\u975eban\u5fc5\u9009\u7684\u4f4d\u7f6e\uff0c\u5c31\u89c9\u5f97\u8d5b\u5bc4\u7684\u6218\u529b\u4e0a\u5347\u7a7a\u95f4\u5de8\u5927[\u7b11\u54ed]',
        'Bilibili video context: \uff3b\u7535\u8d5b\u5bc4\u5f55\uff3d\uff08\u756a\u5916\u7bc7\uff09\u963f\u514b\u66fc\u8f6c\u5411\u7ed3\u6784+\u60ac\u6302\u7ed3\u6784\u540e\u9a71\u5e95\u76d8\u3002',
        'Bilibili video context: \u3010\u8d5b\u5c14\u8ba1\u5212\u3011\u5df4\u91cc\u4fee\u65af1\u547d\u5b9e\u6218\u523b\u5370\u5929\u8d4b\u89e3\u8bf4\uff0c\u88ab5\u547d\u7206\u6740\uff0c\u554a\u554a\u554a\u8d5b\u5bc4\u8d8a\u6765\u8d8a\u96be\u73a9\u4e86',
      ],
      evidenceSources: [
        { source: 'Bilibili public video comment scan', sample: '20w\u4e86\uff0c\u4e0d\u8fc7\u6211\u89c9\u5f97\u5149\u8bc4\u8bba\u5bf9\u8f70\u6ca1\u7528\u554a\uff0c\u8d5b\u5bc4\u90a3\u6b21\u5c31\u51fa\u8fc7\u7c7b\u4f3c\u7684\u4e8b\u4f46\u8fd8\u662f\u6ca1\u7528\uff0c\u5f97\u76f4\u63a5\u6253\u7968\u9000\u94b1\u5dee\u8bc4\u53cd\u9988\u4e3e\u62a5[\u8fa3\u773c\u775b]' },
        { source: 'Bilibili public video comment scan', sample: '\u4e00\u5f00\u59cb\u54c8\u83ab\u8fd9\u79cd\u6218\u529b\u5728\u9694\u58c1\u542f\u822a\u6392\u7b2c\u51e0\u5341\u7684\u89d2\u8272\u5c45\u7136\u80fd\u5728\u8d5b\u5bc4\u5360\u975eban\u5fc5\u9009\u7684\u4f4d\u7f6e\uff0c\u5c31\u89c9\u5f97\u8d5b\u5bc4\u7684\u6218\u529b\u4e0a\u5347\u7a7a\u95f4\u5de8\u5927[\u7b11\u54ed]' },
        { source: 'Bilibili public video context', sample: 'Bilibili video context: \uff3b\u7535\u8d5b\u5bc4\u5f55\uff3d\uff08\u756a\u5916\u7bc7\uff09\u963f\u514b\u66fc\u8f6c\u5411\u7ed3\u6784+\u60ac\u6302\u7ed3\u6784\u540e\u9a71\u5e95\u76d8\u3002' },
        { source: 'Bilibili public video context', sample: 'Bilibili video context: \u3010\u8d5b\u5c14\u8ba1\u5212\u3011\u5df4\u91cc\u4fee\u65af1\u547d\u5b9e\u6218\u523b\u5370\u5929\u8d4b\u89e3\u8bf4\uff0c\u88ab5\u547d\u7206\u6740\uff0c\u554a\u554a\u554a\u8d5b\u5bc4\u8d8a\u6765\u8d8a\u96be\u73a9\u4e86' },
      ],
    },
    {
      term: '\u4e09\u89d2\u8d38\u6613',
      family: 'cooperation',
      meaning: '\u7528\u4e8e\u8c03\u4f83\u591a\u65b9\u4e92\u6362\u3001\u4e92\u76f8\u914d\u5408\u7684\u573a\u666f',
      evidenceCount: 3,
      evidenceSamples: [
        '\u4e09\u89d2\u8d38\u6613\uff0c\u542f\u52a8\uff01',
        '\u4e09\u89d2\u8d38\u6613\u6740',
        '\u4e0d\u4e00\u6837 \u4e09\u89d2\u8d38\u6613\u662f\u8ba9\u4e09\u65b9\u90fd\u975e\u5e38\u6ee1\u610f\u7684\u8d38\u6613\uff0c\u5c24\u5176\u662f\u4e00\u4e9b\u975e\u6d32\u90e8\u843d\u662f\u975e\u5e38\u559c\u6b22\u8d29\u5356\u9ed1\u5974\u7684',
      ],
      evidenceSources: [
        { source: 'Bilibili public video comment scan', sample: '\u4e09\u89d2\u8d38\u6613\uff0c\u542f\u52a8\uff01' },
        { source: 'Bilibili public video comment scan', sample: '\u4e09\u89d2\u8d38\u6613\u6740' },
        { source: 'Bilibili public video comment scan', sample: '\u4e0d\u4e00\u6837 \u4e09\u89d2\u8d38\u6613\u662f\u8ba9\u4e09\u65b9\u90fd\u975e\u5e38\u6ee1\u610f\u7684\u8d38\u6613\uff0c\u5c24\u5176\u662f\u4e00\u4e9b\u975e\u6d32\u90e8\u843d\u662f\u975e\u5e38\u559c\u6b22\u8d29\u5356\u9ed1\u5974\u7684' },
      ],
    },
    {
      term: '\u5b9e\u540d\u5236\u89c2\u770b',
      family: 'cooperation',
      meaning: '\u7528\u4e8e\u8868\u793a\u771f\u8eab\u5728\u573a\u5f0f\u652f\u6301\u6216\u8ba4\u540c',
      evidenceCount: 4,
      evidenceSamples: [
        '\u6211\u89c9\u5f97\u7f51\u7edc\u5b9e\u540d\u5236\u5e94\u8be5\u4ee5\u81ea\u613f\u4e3a\u539f\u5219\uff0c\u5f3a\u5236\u6027\u8981\u6c42\u53ea\u80fd\u9002\u5f97\u5176\u53cd\u3002',
        '\u867d\u7136\u4f46\u662f\uff0c\u7f51\u4e0a\u5b9e\u540d\u5236\u7684\u8bdd\u8fd8\u662f\u8981\u6ce8\u91cd\u9690\u79c1\u4fdd\u62a4\uff0c\u4ee5\u9632\u4e07\u4e00[\u6253call]',
        '\u95ee\u9898\u4e0d\u662f\u5b9e\u540d\u5236\uff0c\u95ee\u9898\u662f\u574f\u4eba\u4e0d\u5b9e\u540d\u5236[doge]',
        '\u672c\u4eba\u5b9e\u540d\u5236\u89c2\u770b\uff0c\u4e09\u8fde\u652f\u6301',
      ],
      evidenceSources: [
        { source: 'Bilibili public video comment scan', sample: '\u6211\u89c9\u5f97\u7f51\u7edc\u5b9e\u540d\u5236\u5e94\u8be5\u4ee5\u81ea\u613f\u4e3a\u539f\u5219\uff0c\u5f3a\u5236\u6027\u8981\u6c42\u53ea\u80fd\u9002\u5f97\u5176\u53cd\u3002' },
        { source: 'Bilibili public video comment scan', sample: '\u867d\u7136\u4f46\u662f\uff0c\u7f51\u4e0a\u5b9e\u540d\u5236\u7684\u8bdd\u8fd8\u662f\u8981\u6ce8\u91cd\u9690\u79c1\u4fdd\u62a4\uff0c\u4ee5\u9632\u4e07\u4e00[\u6253call]' },
        { source: 'Bilibili public video comment scan', sample: '\u95ee\u9898\u4e0d\u662f\u5b9e\u540d\u5236\uff0c\u95ee\u9898\u662f\u574f\u4eba\u4e0d\u5b9e\u540d\u5236[doge]' },
        { source: 'Bilibili public video comment scan', sample: '\u672c\u4eba\u5b9e\u540d\u5236\u89c2\u770b\uff0c\u4e09\u8fde\u652f\u6301' },
      ],
    },
  ]);

  assert.deepEqual(entries.find((entry) => entry.term === '\u8d5b\u5bc4').evidenceSamples, [
    '20w\u4e86\uff0c\u4e0d\u8fc7\u6211\u89c9\u5f97\u5149\u8bc4\u8bba\u5bf9\u8f70\u6ca1\u7528\u554a\uff0c\u8d5b\u5bc4\u90a3\u6b21\u5c31\u51fa\u8fc7\u7c7b\u4f3c\u7684\u4e8b\u4f46\u8fd8\u662f\u6ca1\u7528\uff0c\u5f97\u76f4\u63a5\u6253\u7968\u9000\u94b1\u5dee\u8bc4\u53cd\u9988\u4e3e\u62a5[\u8fa3\u773c\u775b]',
    '\u4e00\u5f00\u59cb\u54c8\u83ab\u8fd9\u79cd\u6218\u529b\u5728\u9694\u58c1\u542f\u822a\u6392\u7b2c\u51e0\u5341\u7684\u89d2\u8272\u5c45\u7136\u80fd\u5728\u8d5b\u5bc4\u5360\u975eban\u5fc5\u9009\u7684\u4f4d\u7f6e\uff0c\u5c31\u89c9\u5f97\u8d5b\u5bc4\u7684\u6218\u529b\u4e0a\u5347\u7a7a\u95f4\u5de8\u5927[\u7b11\u54ed]',
  ]);
  assert.deepEqual(entries.find((entry) => entry.term === '\u4e09\u89d2\u8d38\u6613').evidenceSamples, [
    '\u4e09\u89d2\u8d38\u6613\uff0c\u542f\u52a8\uff01',
    '\u4e09\u89d2\u8d38\u6613\u6740',
  ]);
  assert.deepEqual(entries.find((entry) => entry.term === '\u5b9e\u540d\u5236\u89c2\u770b').evidenceSamples, [
    '\u672c\u4eba\u5b9e\u540d\u5236\u89c2\u770b\uff0c\u4e09\u8fde\u652f\u6301',
  ]);
});
...
test('normalizeKeywordEntries prunes latest harvested product-review and game-mechanic false positives', () => {
  const entries = normalizeKeywordEntries([
    {
      term: '\u4e94\u6bd2\u4ff1\u5168',
      family: 'attack',
      meaning: '\u6307\u67d0\u4eba\u6216\u7fa4\u4f53\u5404\u79cd\u6076\u4e60\u6216\u95ee\u9898\u90fd\u5360\u5168',
      evidenceCount: 3,
      evidenceSamples: [
        '\u56de\u590d @ClaraYMX :\u4e94\u6bd2\u4ff1\u5168\u7684\u4e24\u516c\u6bcd\u662f\u8fd9\u6837\u7684',
        '\u75af\u4e86\u5427\u8fd9\u4e9b\u4eba\uff0c\u9a6c\u7433\u7433\u6280\u672f\u8fd8\u4e94\u6bd2\u4ff1\u5168\uff1f\u5b66\u4e2a\u8bcd\u5c31\u80fd\u5230\u5904\u7528\u554a[\u7b11\u54ed]',
        '\u4e94\u6bd2\u4ff1\u5168\u7684\u6548\u679c\u662f\u4ec0\u4e48\uff0c\u6b63\u9762\u548c\u8d1f\u9762\u6548\u679c\u90fd\u7b97\u5417',
      ],
      evidenceSources: [],
    },
    {
      term: '100\u597d\u8bc4',
      family: 'absolutes',
      meaning: '\u7528\u4f5c\u7edd\u5bf9\u5316\u597d\u8bc4\u6216\u4e0d\u53ef\u7591\u7684\u8bc4\u4ef7\u8868\u8fbe',
      evidenceCount: 4,
      evidenceSamples: [
        '100%\u597d\u8bc4\u8d29\u5b50\u7684\u8bdd\uff0c\u6211\u611f\u89c9\u662f\u6ca1\u5565\u95ee\u9898\u7684',
        '\u95f2\u9c7c\u6709\u4e00\u4e2a\u5dee\u8bc4\uff0c\u600e\u4e48\u80fd\u53d8\u6210\u767e\u5206\u767e\u597d\u8bc4\u7387\u5462\uff1f \u73b0\u5728 \u8bc4\u4ef7364\uff0c\u597d\u8bc4270 \u5dee\u8bc41',
        '\u7b80\u76f4\u626f\uff0c\u6211\u5c31\u662f\u767e\u5206\u767e\u597d\u8bc4\uff0c\u6839\u672c\u4e0d\u9700\u8981\u8fd9\u4e9b\u82b1\u91cc\u80e1\u54e8\u7684',
        '\u4f60\u8fd9\u903b\u8f91\u771f\u662f100\u597d\u8bc4\uff0c\u4e00\u70b9\u95ee\u9898\u90fd\u4e0d\u8bb8\u63d0',
      ],
      evidenceSources: [],
    },
    {
      term: '\u767e\u5206\u767e\u597d\u8bc4\u7387',
      family: 'absolutes',
      meaning: '\u7528\u4e8e\u6279\u8bc4\u7edd\u5bf9\u5316\u597d\u8bc4\u7387\u6216\u4e0d\u53ef\u7591\u7684\u8bc4\u4ef7',
      evidenceCount: 4,
      evidenceSamples: [
        '\u95f2\u9c7c\u6709\u4e00\u4e2a\u5dee\u8bc4\uff0c\u600e\u4e48\u80fd\u53d8\u6210\u767e\u5206\u767e\u597d\u8bc4\u7387\u5462\uff1f \u73b0\u5728 \u8bc4\u4ef7364\uff0c\u597d\u8bc4270 \u5dee\u8bc41',
        '\u7b80\u76f4\u626f\uff0c\u6211\u5c31\u662f\u767e\u5206\u767e\u597d\u8bc4\uff0c\u6839\u672c\u4e0d\u9700\u8981\u8fd9\u4e9b\u82b1\u91cc\u80e1\u54e8\u7684',
        '\u767e\u5206\u767e\u597d\u8bc4\u7387\u5c31\u662f\u767e\u5206\u767e\u6ca1\u6c34\u5206\uff1f\u8fd9\u4e48\u7edd\u5bf9\u7684\u8bdd\u4e5f\u6562\u8bf4',
      ],
      evidenceSources: [],
    },
    {
      term: '\u5dee\u8bc4\u8fde\u5929',
      family: 'evidence',
      meaning: '\u6307\u5411\u5927\u91cf\u8d1f\u9762\u8bc4\u4ef7\u4f5c\u4e3a\u53ef\u67e5\u8bc1\u636e',
      evidenceCount: 2,
      evidenceSamples: [
        '\u5173\u952e7\u4e2a\u6708\u524d\u5f00\u59cb\u5c31\u5dee\u8bc4\u8fde\u5929\u4e86\uff0c\u6700\u8fd1\u8fd8\u6709\u4eba\u4e70\uff0c\u771f\u662f\u4e0d\u4fe1\u90aa\uff1f',
        '\u53bb\u770b\u4ed6\u4e4b\u524d\u7684\u8bb0\u5f55\uff0c\u8bc4\u8bba\u533a\u5dee\u8bc4\u8fde\u5929\u5c31\u662f\u8bc1\u636e',
      ],
      evidenceSources: [],
    },
  ]);

  assert.deepEqual(entries.find((entry) => entry.term === '\u4e94\u6bd2\u4ff1\u5168').evidenceSamples, [
    '\u56de\u590d @ClaraYMX :\u4e94\u6bd2\u4ff1\u5168\u7684\u4e24\u516c\u6bcd\u662f\u8fd9\u6837\u7684',
    '\u75af\u4e86\u5427\u8fd9\u4e9b\u4eba\uff0c\u9a6c\u7433\u7433\u6280\u672f\u8fd8\u4e94\u6bd2\u4ff1\u5168\uff1f\u5b66\u4e2a\u8bcd\u5c31\u80fd\u5230\u5904\u7528\u554a[\u7b11\u54ed]',
  ]);
  assert.deepEqual(entries.find((entry) => entry.term === '100\u597d\u8bc4').evidenceSamples, [
    '\u4f60\u8fd9\u903b\u8f91\u771f\u662f100\u597d\u8bc4\uff0c\u4e00\u70b9\u95ee\u9898\u90fd\u4e0d\u8bb8\u63d0',
  ]);
  assert.deepEqual(entries.find((entry) => entry.term === '\u767e\u5206\u767e\u597d\u8bc4\u7387').evidenceSamples, [
    '\u767e\u5206\u767e\u597d\u8bc4\u7387\u5c31\u662f\u767e\u5206\u767e\u6ca1\u6c34\u5206\uff1f\u8fd9\u4e48\u7edd\u5bf9\u7684\u8bdd\u4e5f\u6562\u8bf4',
  ]);
  assert.deepEqual(entries.find((entry) => entry.term === '\u5dee\u8bc4\u8fde\u5929').evidenceSamples, [
    '\u53bb\u770b\u4ed6\u4e4b\u524d\u7684\u8bb0\u5f55\uff0c\u8bc4\u8bba\u533a\u5dee\u8bc4\u8fde\u5929\u5c31\u662f\u8bc1\u636e',
  ]);
});
...
test('findDictionaryEntriesWithTextEvidence maps missed comment wording variants back to target terms', () => {
  ...
  assert.deepEqual(entries.map((entry) => entry.term), ['\u5835\u4f4f\u4eba\u6c11\u5634', '\u61c2\u7684']);
  assert.equal(entries.every((entry) => entry.evidenceCount === 1), true);
...
test('findDictionaryEntriesWithTextEvidence rejects name-substring evidence for follow-power cooperation terms', () => {
  ...
  assert.deepEqual(supportMatches.map((entry) => entry.term), []);
});
...
test('mergeEntriesIntoDictionary prunes latest harvested loose alias false positives', async () => {
  ...
  try {
    ...
    assert.equal(dictionary.entries.find((item) => item.term === '\u90fd\u662f\u5bb6\u4eba'), undefined);
  } finally {
    await rm(dir, { recursive: true, force: true });
  }
});
...
test('normalizeKeywordEntries prunes latest harvested generic aoligei and rhythm-game title evidence', () => {
  const entries = normalizeKeywordEntries([
    {
      term: '\u5965\u5229\u7ed9',
      family: 'attack',
      meaning: 'hostile meme or scatological jab',
      evidenceCount: 5,
      evidenceSamples: [
        '\u4f60\u4eec\u8bf4\uff0c\u80e1\u6b4c\u56de\u6765\u65f6\u4f1a\u4e0d\u4f1a\u628a\u653e\u5728\u8f66\u91cc\u5fd8\u4e86\u4e22\u6389\u7684\u5965\u5229\u7ed9\u5f53\u6210\u76f2\u76d2\u9001\u5176\u4ed6\u660e\u661f\uff1f',
        '\u56de\u590d @\u5e26\u7740\u6653\u7ec4\u7ec7\u6253\u6e38\u620f :\u73b0\u5728\u56de\u665a\u4e0d\u665a\uff1f43080815066 \u8fd9\u662f\u4ed6\u7684\u5c0f\u53f7ID\uff0c\u4ed6\u7684\u552f\u4e00\u5173\u6ce8\u5c31\u662f\u4ed6\u5927\u53f7\u5965\u5229\u7ed9\u3002',
        '\u6709\u5965\u5229\u7ed9\u89c6\u9891\u561b\u8001\u54e5',
        '\u83b1\u5965\u5229\u7ed9\u6211\u7ed9\u4f60\u628a\u9524\u5b50',
        '\u5965\u529b\u7ed9',
      ],
    },
    {
      term: '\u8282\u594f\u72d7',
      family: 'attack',
      meaning: 'insult for people stirring rhythm or drama',
      evidenceCount: 3,
      evidenceSamples: [
        '\u56de\u590d @G\u82b1\u5357\u57ce6 :\u5996\u5200\u662f\u4e3a\u6570\u4e0d\u591a\u6b63\u4e3b\u4e0b\u573a\u7684\u8282\u594f\u72d7',
        '\u6709\u7406\u89e3\u7684\u4e0d\u548b\u5237\u653b\u7565\uff0c\u5185\u5fc3\u8ba4\u5b9a\u7684\u4e1c\u897f\u4e5f\u4e0d\u4f1a\u8f7b\u6613\u53d8\u52a8\uff0c\u7406\u89e3\u5dee\u4e00\u4e9b\u7684\u5f97\u4e3a\u4e86\u81ea\u5df1\u7740\u60f3\u800c\u67e5\u653b\u7565\uff0c\u8fd9\u65f6\u5019\u53c2\u5dee\u4e0d\u9f50\u7684\u653b\u7565\u53c8\u4f1a\u5f71\u54cd\u601d\u60f3\uff0c\u6240\u4ee5\u5efa\u8bae\u4f4e\u521b\u8282\u594f\u72d7\u80fd\u4e0d\u80fd\u4f3c',
        '\u300a\u8282\u594f\u72d7\u751f\u300b',
      ],
    },
  ]);
...
test('normalizeKeywordEntries prunes latest flash harvest genre, platform, and generic reaction noise', () => {
  const entries = normalizeKeywordEntries([
    {
      term: '\u5c2c\u5230\u62a0\u811a',
      family: 'attack',
      meaning: 'generic embarrassment description mislabeled as attack',
      evidenceCount: 2,
      evidenceSamples: [
        '\u518d\u8fc7\u4e94\u5e74\u5979\u4eec\u8981\u80fd\u542c\u5230\u81ea\u5df1\u8fd9\u6bb5\u8bed\u97f3\u6015\u662f\u5f97\u5c2c\u5230\u62a0\u811a\u5427[\u85cf\u72d0]',
        '\u592a\u5c34\u5c2c\u4e86 \u542c\u5f97\u6211\u811a\u8dbe\u5728\u5730\u4e0a\u62a0\u51fa\u4e09\u5ba4\u4e00\u5385',
      ],
    },
    {
      term: '\u4e0d\u7edd\u5bf9\u4f46\u97e9\u56fd\u4e0d\u5c11',
      family: 'cooperation',
      meaning: 'broad celebrity-industry generalization mislabeled as cooperation',
      evidenceCount: 1,
      evidenceSamples: ['\u800c\u4e14\u8d8a\u662f\u5bb6\u5883\u4e0d\u597d\u4e0a\u6765\u7684\u8d8a\u5bf9\u8eab\u8fb9\u4eba\u4e0d\u597d\uff08\u4e0d\u7edd\u5bf9\u4f46\u97e9\u56fd\u4e0d\u5c11\uff09'],
    },
    {
      term: '\u8d5b\u5b63\u86cb',
      family: 'cooperation',
      meaning: 'game item discussion mislabeled as cooperation',
      evidenceCount: 2,
      evidenceSamples: [
        '\u9b3c\u53d4\u5e2e\u5fd9\u53cd\u9988\u4e00\u4e0b\u8d5b\u5b63\u86cb\u5927\u90e8\u5206\u6027\u683c\u90fd\u4e0d\u5bf9\u7684\u95ee\u9898',
        '\u5f80\u8d5b\u5b63\u86cb\u91cc\u585e\u6bd2\uff0c\u7b56\u5212\u554a\uff0c\u771f\u662f\u5acc\u4eba\u591a\u4e86',
      ],
    },
    {
      term: '\u7761\u524d\u5c0f\u751c\u997c',
      family: 'cooperation',
      meaning: 'fiction genre praise mislabeled as cooperation',
      evidenceCount: 1,
      evidenceSamples: ['\u597d\u770b\u7684\uff0c\u751c\uff0c\u8282\u594f\u4e5f\u5f88\u597d\u653b\u53d7\u4eba\u8bbe\u4e5f\u6ca1\u5565\u69fd\u70b9\uff0c\u7761\u524d\u5c0f\u751c\u997c\u6211\u8e0f\u9a6c\u5543\u5543\u5543[doge]'],
    },
    {
      term: '\u5c0f\u751c\u997c',
      family: 'cooperation',
    ...
    },
    {
      term: '\u76f4\u7537\u4e0d\u7ba1\u5bf9\u65b9\u53eb\u8001\u5a46',
      family: 'cooperation',
      meaning: 'romance-comment sentence fragment mislabeled as cooperation',
      evidenceCount: 1,
      evidenceSamples: ['\u8001\u5e08\u6211\u4eec\u8fd9\u76f4\u7537\u4e0d\u7ba1\u5bf9\u65b9\u53eb\u8001\u5a46[\u5403\u74dc]'],
    },
    {
      term: '\u4e0d\u4e89\u4e0d\u62a2\u5ab3\u5987\u513f\u5c31\u98de\u4e86',
      family: 'cooperation',
      meaning: 'fiction romance joke mislabeled as cooperation',
      evidenceCount: 1,
      evidenceSamples: ['\u4e0d\u4e89\u4e0d\u62a2\u5ab3\u5987\u513f\u5c31\u98de\u4e86[doge]'],
    },
    {
      term: '\u4e0d\u77e5\u9053ai\u5ba1\u6838',
      family: 'attack',
      meaning: 'platform moderation complaint mislabeled as attack',
      evidenceCount: 1,
      evidenceSamples: ['\u4e0d\u77e5\u9053 ai \u5ba1\u6838\uff1f'],
    },
    {
      term: '\u538b\u529b\u6765\u5230\u4e86\u5c0f\u7334\u8fd9\u8fb9',
      family: 'cooperation',
      meaning: 'bare meme handoff mislabeled as cooperation',
      evidenceCount: 1,
      evidenceSamples: ['\u538b\u529b\u6765\u5230\u4e86\u5c0f\u7334\u8fd9\u8fb9'],
    },
    {
      term: '\u54ea\u6839\u8471',
      family: 'attack',
      meaning: 'direct belittling attack',
      evidenceCount: 1,
      evidenceSamples: ['\u5dee\u8fdc\u4e86\uff0c\u5f20\u56fd\u4f1f\u662f\u4e2d\u56fd\u8df3\u9ad8\u5386\u53f2\u4e0a\u5199\u4e0b\u6d53\u58a8\u91cd\u5f69\u7684\u4eba\uff0c\u5979\u7b97\u4e86\u54ea\u6839\u8471'],
    },
  ]);
...
test('normalizeKeywordEntries prunes current harvest praise, platform, identity, and weak-reaction noise', () => {
  const entries = normalizeKeywordEntries([
    {
      term: '\u5f88\u68d2\u5148\u751f',
      family: 'cooperation',
      meaning: 'generic praise sentence fragment mislabeled as cooperation',
      evidenceCount: 1,
      evidenceSamples: ['\u8fd9\u5f88\u68d2\uff0c\u5148\u751f'],
    },
    {
      term: '\u6211\u5c06\u652f\u4ed8\u60a8\u753b\u753b\u7684\u8d39\u7528',
      family: 'cooperation',
      meaning: 'commission/payment sentence fragment mislabeled as cooperation',
      evidenceCount: 1,
      evidenceSamples: ['\u6211\u5c06\u652f\u4ed8\u60a8\u753b\u753b\u7684\u8d39\u7528'],
    },
    {
      term: '\u8fd9\u5f88\u68d2\u5148\u751f',
      family: 'cooperation',
    ...
    },
    {
      term: '\u76f4\u8a00\u4e0d\u8bb3',
      family: 'attack',
      meaning: 'neutral candor phrase mislabeled as attack',
      evidenceCount: 1,
      evidenceSamples: ['\u300a\u4f7f\u300b\u2026\u2026\u76f4\u8a00\u4e0d\u8bb3\u8fd9\u4e00\u5757'],
    },
    {
      term: '\u8349\u751f',
      family: 'cooperation',
      meaning: 'generic reaction phrase mislabeled as cooperation',
      evidenceCount: 3,
      evidenceSamples: ['\u592a\u751f\u8349\u4e86', '\u54c8\u54c8\u54c8\u54c8\uff0c\u8fc7\u4e8e\u751f\u8349', '\u8349\u4e86\u600e\u4e48\u8fd8\u662f\u5e03\u7f57\u5229\u7684\u5934\u50cf'],
    },
    {
      term: '\u798f\u745e\u63a7',
      family: 'cooperation',
      meaning: 'fandom identity term mislabeled as cooperation',
      evidenceCount: 2,
      evidenceSamples: ['\u798f\u745e\u63a7\u770b\u7684\u5f88\u723d\u8c22\u8c22', '\u8fd9\u89d2\u8272\u4e00\u770b\u5c31\u662ffurry\u63a7\u4f1a\u559c\u6b22\u7684\u798f\u745e'],
    },
    {
      term: '\u5e3d\u5b50\u53d4',
      family: 'cooperation',
      meaning: 'police euphemism mislabeled as cooperation',
      evidenceCount: 1,
      evidenceSamples: ['\u51fa\u4e8b\u4e4b\u540e\u76f4\u63a5\u627e\u5e3d\u5b50\u53d4\u53d4\u8c03\u89e3'],
    },
    {
      term: '\u5e3d\u5b50\u53d4\u53d4',
      family: 'cooperation',
      meaning: 'police euphemism mislabeled as cooperation',
      evidenceCount: 1,
      evidenceSamples: ['\u8fd9\u4e2a\u84dd\u8272\u8863\u670d\u7684\u5e3d\u5b50\u53d4\u53d4\u8bf7\u95ee\u662f\u600e\u4e48\u56de\u4e8b\uff1f'],
    },
    {
      term: '\u5c0f\u9ec4\u9c7c',
      family: 'cooperation',
      meaning: 'marketplace/platform slang mislabeled as cooperation',
      evidenceCount: 2,
      evidenceSamples: ['\u5c0f\u9ec4\u9c7c\u4e0a\u6210\u8272\u65b0\u4e00\u70b9\u7684\u57fa\u672c\u4e0a\u90fd\u662f\u62fc\u88c5\u673a', '\u7ecf\u5178\u5c0f\u9ec4\u9c7c\u780d\u4ef7'],
    },
    {
      term: '\u4e94\u7ef4\u56fe\u5168\u90fd\u4f4e\u7684\u53ef\u601c',
      family: 'absolutes',
      meaning: 'game-stat description mislabeled as absolute thinking',
      evidenceCount: 1,
      evidenceSamples: ['\u4e94\u7ef4\u56fe\u5168\u90fd\u4f4e\u7684\u53ef\u601c\u7684\u90a3\u79cd'],
    },
    {
      term: '\u6253\u4e86\u81ea\u5df1\u7535\u8bdd',
      family: 'cooperation',
      meaning: 'video-participation reaction mislabeled as cooperation',
      evidenceCount: 1,
      evidenceSamples: ['\u6211\u770b\u6709\u591a\u5c11\u770b\u89c6\u9891\u7684\u65f6\u5019\u6253\u4e86\u81ea\u5df1\u7535\u8bdd\u7684[\u5403\u74dc]'],
    },
    {
      term: 'up\u597d\u725b',
      family: 'cooperation',
      meaning: 'generic uploader praise mislabeled as cooperation',
      evidenceCount: 1,
      evidenceSamples: ['up\u597d\u725b'],
    },
    {
      term: '\u8098\u904d\u5168\u7f51',
      family: 'absolutes',
      meaning: 'bare meme label mislabeled as absolute thinking',
      evidenceCount: 1,
      evidenceSamples: ['\u8098\u904d\u5168\u7f51\ud83d\udcaa\ud83c\udffb'],
    },
    {
      term: '\u996d\u5708\u5473',
      family: 'attack',
      meaning: 'accuses a discussion or activity of fandom-war logic',
      evidenceCount: 1,
      evidenceSamples: ['\u8fd9\u996d\u5708\u5473\u548b\u8fd9\u4e48\u91cd'],
    },
    {
      term: '\u7eaf\u5c0f\u4eba',
      family: 'attack',
      meaning: 'direct moral attack',
      evidenceCount: 1,
      evidenceSamples: ['\u8fd9\u79cd\u80cc\u540e\u6697\u6233\u6233\u5ac9\u5992\u7684\u884c\u4e3a\u771f\u7684\u7eaf\u5c0f\u4eba'],
    },
  ]);
...
test('normalizeKeywordEntries prunes latest auto-coverage fragment, praise, proper-name, and entertainment noise', () => {
  const entries = normalizeKeywordEntries([
    {
      term: '\u9ad8\u5b8c\u4e86',
      family: 'attack',
      meaning: 'short fragment copied from a fuller sarcasm phrase',
      evidenceCount: 1,
      evidenceSamples: ['\u90fd\u8ba9\u4f60\u9ad8\u5b8c\u4e86\ud83d\ude05'],
    },
    {
      term: '\u5999\u554a',
      family: 'cooperation',
      meaning: 'generic praise or emote label',
      evidenceCount: 3,
      evidenceSamples: ['\u5999\u554a', '\u51b0\u7bb1\u89c6\u89d2\uff0c\u89c2\u4f17\u8eab\u5904\u4fe1\u606f\u8327\u623f\uff0c\u955c\u5934\u8bed\u8a00\u5999\u554a[\u6253call]', '\u8fd9\u6ce2\u6211\u7adf\u4e0d\u77e5\u9053\u4f60\u5728\u7b2c\u51e0\u5c42[\u5999\u554a-\u5723\u8bde]'],
    },
    {
      term: '\u5ddd\u5efa\u56fd',
      family: 'attack',
      meaning: 'proper-name nickname for Trump, not an attack-language marker by itself',
      evidenceCount: 5,
      evidenceSamples: ['\u5ddd\u5efa\u56fd\uff1a\u62a5\u544a\u7ec4\u7ec7\uff01\u9ad8\u79d1\u6280\u53ca\u519c\u4e1a\u6253\u51fb\u5b8c\u6bd5\uff01', '\u65b0\u751f\u4ee3\u9b3c\u755c\u4e4b\u738b\u7279\u6717\u666e\uff08\u771f\u540d\u5ddd\u5efa\u56fd\uff09[\u6ed1\u7a3d]'],
    },
    {
      term: '\u5ddd\u666e',
      family: 'attack',
      meaning: 'proper-name nickname, not an attack-language marker by itself',
      evidenceCount: 5,
      evidenceSamples: ['\u5ddd\u666e\u5fc3\u91cc\u6ca1\u70b9b\u6570\u561b[\u62a0\u9f3b]', '\u4e4b\u524d\u770b\u5230\u4e00\u4e2aup\u5410\u69fd\u7279\u6717\u666e'],
    },
    {
      term: '\u675c\u752b\u7b2c\u4e00\u674e\u767d\u4e0d\u53c2\u4e0e\u6392\u540d',
      family: 'absolutes',
      meaning: 'poetry ranking sentence copied as an absolute-thinking term',
      evidenceCount: 1,
      evidenceSamples: ['\u675c\u752b\u7b2c\u4e00\uff0c\u674e\u767d\u4e0d\u53c2\u4e0e\u6392\u540d'],
    },
    {
      term: '\u674e\u767d\u4e0d\u53c2\u4e0e\u6392\u540d',
      family: 'absolutes',
      meaning: 'poetry ranking fragment copied as an absolute-thinking term',
      evidenceCount: 1,
      evidenceSamples: ['\u675c\u752b\u7b2c\u4e00\uff0c\u674e\u767d\u4e0d\u53c2\u4e0e\u6392\u540d'],
    },
    {
      term: '\u5168\u662f\u6211\u4eec\u9a6c\u54e5',
      family: 'absolutes',
      meaning: 'fandom/person search result reaction',
      evidenceCount: 1,
      evidenceSamples: ['\u771f\u7edd\u4e86\uff0c\u4e00\u641c\u5c0f\u53d4\u6587\u5b66\uff0c\u5168\u662f\u6211\u4eec\u9a6c\u54e5[\u8131\u5355doge]'],
    },
    {
      term: '\u4f1a\u4e91\u591a\u4e91',
      family: 'cooperation',
      meaning: 'loose entertainment pun without argumentative function',
      evidenceCount: 1,
      evidenceSamples: ['\u54c8\u54c8\u54c8\u4f1a\u4e91\u591a\u4e91'],
    },
    {
      term: '\u5c0f\u53d4\u6587\u5b66',
      family: 'cooperation',
      meaning: 'fiction trope label, not a debate or attack-language marker',
      evidenceCount: 3,
      evidenceSamples: ['\u4e00\u4e2a\u72fc\u5d3d\u5b50\uff0c\u4e00\u4e2a\u50b2\u5a07\u732b\u54aa\uff0c\u5269\u4e0b\u662f\u5c0f\u53d4\u6587\u5b66[doge]', '\u4e00\u4e2a\u5c0f\u5988\u6587\u5b66\uff0c\u4e00\u4e2a\u9738\u603b\u6587\u5b66\uff0c\u4e00\u4e2a\u5c0f\u53d4\u6587\u5b66[\u661f\u661f\u773c]'],
    },
    {
      term: '\u90fd\u8ba9\u4f60\u9ad8\u5b8c\u4e86',
      family: 'attack',
      meaning: 'sarcastic full phrase aimed at another speaker',
      evidenceCount: 1,
      evidenceSamples: ['\u90fd\u8ba9\u4f60\u9ad8\u5b8c\u4e86\ud83d\ude05'],
    },
    {
      term: '\u5835\u4f4f\u4eba\u6c11\u5634',
      family: 'attack',
      meaning: 'accuses another side of silencing criticism',
      evidenceCount: 1,
      evidenceSamples: ['\u6211\u55b7\u7684\u662f\u756a\u8304\u8bc4\u8bba\u4e0d\u8ba9\u4eba\u8bf4\u8bdd\u7684\u4e8b\uff0c\u4f60\u518d\u8ddf\u6211\u626f\u4ec0\u4e48\uff0c\u5835\u4f4f\u4eba\u6c11\u5634\u4e0d\u7136\u4eba\u6c11\u8bf4\u8bdd\u4f60\u5f88\u7406\u76f4\u6c14\u58ee\u5417[\u661f\u661f\u773c]'],
    },
    {
      term: '\u591a\u5c11\u6709\u70b9\u5c0f\u4e11',
      family: 'attack',
      meaning: 'directly mocks a stance as clownish',
      evidenceCount: 1,
      evidenceSamples: ['\u771f\u89c9\u5f97\u52d2\u514b\u83b1\u5c14\u6162\u90a3\u591a\u5c11\u6709\u70b9\u5c0f\u4e11'],
    },
  ]);
...
test('normalizeKeywordEntries prunes latest auto-coverage fandom, title, platform, and emote noise', () => {
  const entries = normalizeKeywordEntries([
    {
      term: '\u90fd\u662f\u5bb6\u4eba',
      family: 'cooperation',
      meaning: 'generic fandom or family address, not cooperation language',
      evidenceCount: 6,
      evidenceSamples: [
        '\u62dc\u4ec1\u548c\u5927\u5bb6\u90fd\u662f\u5bb6\u4eba',
        '\u5bb6\u4eba\u4eec\u53ef\u4ee5\u9f13\u52b1\u6211\u5417',
    ...
    },
    {
      term: '\u6050\u6016\u7ae5\u8c23\u7edd\u5bf9\u7b2c\u4e00',
      family: 'absolutes',
      meaning: 'entertainment ranking sentence, not stable absolute-thinking language',
      evidenceCount: 1,
      evidenceSamples: ['\u8c01\u61c2\u554a\uff0c\u6050\u6016\u7ae5\u8c23\u7edd\u5bf9\u7b2c\u4e00'],
    },
    {
      term: 'py\u73b0\u573a',
      family: 'attack',
      meaning: 'bare scene label without directed attack semantics',
      evidenceCount: 1,
      evidenceSamples: ['PY\u73b0\u573a(\u0e05>\u03c9<*\u0e05)'],
    },
    {
      term: '\u5173\u6ce8\u529b',
      family: 'cooperation',
      meaning: 'creator follow prompt or generic attention phrase',
      evidenceCount: 2,
      evidenceSamples: ['\u4f18\u8d28up\uff0c\u5173\u6ce8\u529b[\u5999\u554a]', '\u5173\u6ce8\u529b\u60ca\u4eba'],
    },
    {
      term: '\u4e09\u8054',
      family: 'cooperation',
      meaning: 'Bilibili platform engagement action',
      evidenceCount: 2,
      evidenceSamples: ['\u8fd9\u4e0d\u4e09\u8054\u8fd8\u7b49\u5565\uff1f', '\u4e09\u8054'],
    },
    {
      term: '\u9ad8\u5983\u5e94\u5f97\u7684\u5f85\u9047',
      family: 'attack',
      meaning: 'fandom-specific phrase without portable attack-language value',
      evidenceCount: 1,
      evidenceSamples: ['\u9ad8\u5983\u5e94\u5f97\u7684\u5f85\u9047'],
    },
    {
      term: '\u6b63\u9053\u7684\u5149',
      family: 'attack',
      meaning: 'generic slogan or meme praise in current evidence',
      evidenceCount: 3,
      evidenceSamples: ['[\u594b\u6597]\u6b63\u9053\u7684\u5149\u2014\u2014\uff01', '\u6b63 \u9053 \u7684 \u5149 \u7167\u5728\u4e86\u5927\u5730\u4e0a\uff01'],
    },
    {
      term: '\u659c\u773c\u7b11',
      family: 'attack',
      meaning: 'emote label rather than attack-language term',
      evidenceCount: 3,
      evidenceSamples: ['\u9ad8\u6d77\u5b9d\uff1a\u8ddf\u54e5\u4eec\u513f\u5206\u4eab\u6602[tv_\u659c\u773c\u7b11]'],
    },
    {
      term: 'tv\u659c\u773c\u7b11',
      family: 'attack',
      meaning: 'emote label rather than attack-language term',
      evidenceCount: 3,
      evidenceSamples: ['\u56de\u590d @\u5c0f\u5305\u5c0f\u5305i :\u5927\u578b\u7ffb\u8f66\u73b0\u573a[tv_\u659c\u773c\u7b11][\u70ed\u8bcd\u7cfb\u5217_\u5371]'],
    },
    {
      term: '\u611f\u8c22\u6307\u6b63',
      family: 'correction',
      meaning: 'accepts a correction',
      evidenceCount: 1,
      evidenceSamples: ['\u611f\u8c22\u6307\u6b63[\u4fdd\u536b\u841d\u535c_\u54ed\u54ed]'],
    },
    {
      term: '\u5e72\u5d29\u963f',
      family: 'attack',
      meaning: 'platform-directed hostile shorthand',
      evidenceCount: 1,
      evidenceSamples: ['\u9053\u53cb\u4eec\uff0c\u54b1\u4eec\u76f8\u7ea6613\u5e72\u5d29\u963fB'],
    },
    {
      term: '\u6839\u672c\u6ca1\u6709\u8bf4\u4e0d\u5141\u8bb8',
      family: 'absolutes',
      meaning: 'contradicts a claim about what was allowed',
      evidenceCount: 1,
      evidenceSamples: ['\u56de\u590d @\u732b\u732b\u7a81\u7a81\u961f :\u5bf9\u65b9\u6839\u672c\u6ca1\u6709\u8bf4\u4e0d\u5141\u8bb8\u5176\u4ed6\u6c11\u65cf\u4f7f\u7528'],
    },
    {
      term: 'td\u5c0f\u9752\u86d9',
      family: 'attack',
      meaning: 'hostile faction or identity label',
      evidenceCount: 1,
      evidenceSamples: ['\u56de\u590d @1mk\u7684\u897f\u74dc :\u90a3\u4e9b\u4eba\u5341\u6709\u516b\u4e5d\u90fd\u662ftd\u5c0f\u9752\u86d9\uff0c\u6076\u5fc3\u5410\u4e86'],
    },
  ]);
...
test('normalizeKeywordEntries prunes latest coverage batch broad-region, praise, and alliance noise', () => {
  const entries = normalizeKeywordEntries([
    {
      term: '\u5e7f\u4e1c\u7684',
      family: 'attack',
      meaning: 'overbroad regional fragment from IP accusation evidence',
      evidenceCount: 3,
      evidenceSamples: [
        '\u5176\u5b9e\u4ed4\u7ec6\u770b\u5c31\u4f1a\u53d1\u73b0\uff0c\u5168\u662f\u5e7f\u4e1c\u7684ip\uff0c\u4ec0\u4e48\u6210\u5206\u4e0d\u7528\u6211\u591a\u8bf4\u4e86\u5427',
        'Bilibili public video title: \u4e00\u4e2a\u5ac1\u5e7f\u4e1c\u7684\u8282\u594f',
      ],
    },
    {
      term: '\u7b11\u563b\u4e86',
      family: 'cooperation',
      meaning: 'generic laughing reaction',
      evidenceCount: 2,
      evidenceSamples: ['\u89c6\u9891\u6ca1\u770b\u7b11\uff0c\u8fd9\u903cbgm\u7ed9\u8001\u5b50\u6574\u7684\u7b11\u563b\u4e86', '\u5f39\u5e55\u5bf9\u53f7\u5165\u5ea7\u7b11\u563b\u4e86'],
    },
    {
      term: '\u62d4\u7fa4',
      family: 'cooperation',
      meaning: 'generic effect praise fragment',
      evidenceCount: 3,
      evidenceSamples: ['\u96f7\u6253\u6c34\uff0c\u6548\u679c\u62d4\u7fa4'],
    },
    {
      term: '\u6548\u679c\u62d4\u7fa4',
      family: 'cooperation',
      meaning: 'generic effect praise',
      evidenceCount: 3,
      evidenceSamples: ['\u56de\u590d @\u7acb\u8f69-\u5ddd\u9f99 :\u4e0d\u4e0d\u4e0d\uff0c\u88ab\u6000\u7591\u4e86\u4e5f\u53ef\u4ee5\u76f4\u63a5\u9644\u548c\uff0c\u6548\u679c\u62d4\u7fa4'],
    },
    {
      term: '\u7f57\u795e\u4f1f\u5927',
      family: 'absolutes',
      meaning: 'idol praise rather than useful closed-thinking marker',
      evidenceCount: 1,
      evidenceSamples: ['\u7f57\u795e\u4f1f\u5927\uff0c\u65e0\u9700\u591a\u8a00\u3002'],
    },
    {
      term: '\u56fd\u9645\u5b85\u7537\u8054\u76df',
      family: 'attack',
      meaning: 'over-specific humorous faction phrase',
      evidenceCount: 1,
      evidenceSamples: ['\u56de\u590d @\u7535\u73a9\u96f7\u8bfa :\u7ec4\u5efa\u4e00\u53ea\u56fd\u9645\u5b85\u7537\u8054\u76df\u5427\uff0c\u662f\u65f6\u5019\u51fa\u5175\u5f81\u670d\u7f8e\u56fd\u4e86\uff01'],
    },
    {
      term: '\u5b85\u7537\u8054\u76df',
      family: 'attack',
      meaning: 'over-specific humorous faction fragment',
      evidenceCount: 1,
      evidenceSamples: ['\u56de\u590d @\u7535\u73a9\u96f7\u8bfa :\u7ec4\u5efa\u4e00\u53ea\u56fd\u9645\u5b85\u7537\u8054\u76df\u5427\uff0c\u662f\u65f6\u5019\u51fa\u5175\u5f81\u670d\u7f8e\u56fd\u4e86\uff01'],
    },
    {
      term: '\u597d\u65f6\u4ee3\u6765\u4e34\u529b',
      family: 'cooperation',
      meaning: 'generic positive meme sentence',
      evidenceCount: 1,
      evidenceSamples: ['\u611f\u89c9\u79cd\u5b50\u9650\u65f6\u671f\u95f4\u5e94\u8be5\u662f\u5404\u79cd\u65e0\u85cf\u6253\u6cd5\u7684\u4e95\u55b7\u671f\u4e86\uff0c\u597d\u65f6\u4ee3\u6765\u4e34\u529b\uff01'],
    },
    {
      term: '\u5168\u662f\u5e7f\u4e1c\u7684',
      family: 'attack',
      meaning: 'regional IP accusation used as hostile labeling',
      evidenceCount: 3,
      evidenceSamples: ['\u5176\u5b9e\u4ed4\u7ec6\u770b\u5c31\u4f1a\u53d1\u73b0\uff0c\u5168\u662f\u5e7f\u4e1c\u7684ip\uff0c\u4ec0\u4e48\u6210\u5206\u4e0d\u7528\u6211\u591a\u8bf4\u4e86\u5427'],
    },
    {
      term: '\u5168\u662f\u6c34\u519b',
      family: 'attack',
      meaning: 'accuses a comment area of paid astroturfing',
      evidenceCount: 2,
      evidenceSamples: ['\u8bc4\u8bba\u533a\u5168\u662f\u6c34\u519b\uff0c\u53d8\u7740\u6cd5\u7684\u8ba9\u4f60\u76f8\u4fe1\u66f4\u7cfb\u7edf\u662f\u597d\u4e8b'],
    },
    {
      term: '\u6709\u4eba\u6025\u4e86',
      family: 'attack',
      meaning: 'mocks another side as being upset',
      evidenceCount: 3,
      evidenceSamples: ['\u6709\u4eba\u6025\u4e86\uff0c\u9648\u8ff0\u4e8b\u5b9e\u5c31\u522b\u6025'],
    },
    {
      term: 'hapi\u8a00\u8bba',
      family: 'attack',
      meaning: 'obfuscated insult labeling another claim',
      evidenceCount: 1,
      evidenceSamples: ['\u6765\u4e86\u6765\u4e86hapi\u8a00\u8bba\u53c8\u6765\u4e86\uff0c\u5ddd\u666e\u5fc3\u91cc\u6ca1\u70b9b\u6570\u561b'],
    },
  ]);

  assert.deepEqual(entries.map((entry) => [entry.term, entry.evidenceSamples]), [
    ['\u5168\u662f\u5e7f\u4e1c\u7684', ['\u5176\u5b9e\u4ed4\u7ec6\u770b\u5c31\u4f1a\u53d1\u73b0\uff0c\u5168\u662f\u5e7f\u4e1c\u7684ip\uff0c\u4ec0\u4e48\u6210\u5206\u4e0d\u7528\u6211\u591a\u8bf4\u4e86\u5427']],
    ['\u5168\u662f\u6c34\u519b', ['\u8bc4\u8bba\u533a\u5168\u662f\u6c34\u519b\uff0c\u53d8\u7740\u6cd5\u7684\u8ba9\u4f60\u76f8\u4fe1\u66f4\u7cfb\u7edf\u662f\u597d\u4e8b']],
    ['\u6709\u4eba\u6025\u4e86', ['\u6709\u4eba\u6025\u4e86\uff0c\u9648\u8ff0\u4e8b\u5b9e\u5c31\u522b\u6025']],
    ['hapi\u8a00\u8bba', ['\u6765\u4e86\u6765\u4e86hapi\u8a00\u8bba\u53c8\u6765\u4e86\uff0c\u5ddd\u666e\u5fc3\u91cc\u6ca1\u70b9b\u6570\u561b']],
  ]);
});

test('normalizeKeywordEntries prunes current coverage batch narrow meme, fandom, and tool-object noise', () => {
  const entries = normalizeKeywordEntries([
    {
      term: '\u6218\u7ee9\u6e05\u96f6\u5361',
      family: 'attack',
      meaning: 'over-specific game-card style metaphor',
      evidenceCount: 1,
      evidenceSamples: ['\u4f7f\u7528\u6218\u7ee9\u6e05\u96f6\u5361\u8fd9\u4e00\u5757'],
    },
    {
      term: '\u95ee\u8001\u9a6c\u672c\u4eba',
      family: 'evasion',
      meaning: 'over-specific name-based deflection',
      evidenceCount: 1,
      evidenceSamples: ['\u95ee\u4e86\u4e00\u5708\u5c31\u662f\u4e0d\u95ee\u672c\u4eba'],
    },
    {
      term: '\u4e09\u5e74\u5c31\u8d70\u4e86',
      family: 'attack',
      meaning: 'over-specific morbidity joke fragment',
      evidenceCount: 1,
      evidenceSamples: ['\u4e5f\u6709\u53ef\u80fd\u56e0\u4e3a\u6ca1\u5403\u836f\u5f97\u5fc3\u810f\u75c5\uff0c\u4e09\u5e74\u5c31\u8d70\u4e86'],
    },
    {
      term: '\u597d\u78d5\u7684\u5f88',
      family: 'cooperation',
      meaning: 'fandom shipping praise',
      evidenceCount: 1,
      evidenceSamples: ['\u597d\u78d5\u7684\u5f88\uff0c\u6700\u8fd1\u51fa\u4e86\u597d\u591a\u6211\u7a00\u7f55\u7684'],
    },
    {
      term: '\u54b1\u4eec\u773c\u5149\u4e00\u6837',
      family: 'cooperation',
      meaning: 'generic agreement praise',
      evidenceCount: 1,
      evidenceSamples: ['\u54b1\u4eec\u773c\u5149\u4e00\u6837\uff0c\u54c8\u54c8\u54c8\uff0c\u6211\u6700\u8fd1\u4e5f\u662f\u6700\u559c\u6b22\u4ed6\u4eec\u4e09\u4e2a'],
    },
    {
      term: '\u5feb\u901f\u5e73\u6574',
      family: 'attack',
      meaning: 'tool-object fragment from nuclear joke',
      evidenceCount: 1,
      evidenceSamples: ['\u4ec0\u4e48\u6838\u5f39\uff0c\u8fd9\u660e\u660e\u662f\u571f\u5730\u5feb\u901f\u5e73\u6574\u5668'],
    },
    {
      term: '\u5e73\u6574\u5668',
      family: 'attack',
      meaning: 'tool-object suffix fragment',
      evidenceCount: 1,
      evidenceSamples: ['\u4ec0\u4e48\u6838\u5f39\uff0c\u8fd9\u660e\u660e\u662f\u571f\u5730\u5feb\u901f\u5e73\u6574\u5668'],
    },
    {
      term: '\u571f\u5730\u5feb\u901f\u5e73\u6574\u5668',
      family: 'attack',
      meaning: 'over-specific tool-object nuclear joke',
      evidenceCount: 1,
      evidenceSamples: ['\u4ec0\u4e48\u6838\u5f39\uff0c\u8fd9\u660e\u660e\u662f\u571f\u5730\u5feb\u901f\u5e73\u6574\u5668'],
    },
    {
      ...
      evidenceCount: 2,
      evidenceSamples: ['\u522b\u4e70\uff0c\u6beb\u65e0\u540a\u7528'],
    },
    {
      term: '\u7f55\u89c1ip',
      family: 'attack',
      meaning: 'regional IP sarcasm',
      evidenceCount: 2,
      evidenceSamples: ['\u7f55\u89c1IP[\u7b11\u54ed]'],
    },
    {
      term: '\u65e0\u8111\u55b7',
      family: 'attack',
      meaning: 'accuses others of brainless criticism',
      evidenceCount: 2,
      evidenceSamples: ['\u662f\u7684\u5f88\u591a\u4eba\u771f\u7684\u65e0\u8111\u55b7[\u5403\u74dc]'],
    },
  ]);
...
test('normalizeKeywordEntries prunes latest low-yield coverage game-mode and narrow question noise', () => {
  const entries = normalizeKeywordEntries([
    {
      term: '\u6781\u9650\u6a21\u5f0f',
      family: 'cooperation',
      meaning: 'literal game difficulty mode',
      evidenceCount: 1,
      evidenceSamples: ['\u6709\u590d\u6d3b\u88c5\u5907\u5c31\u4e0d\u5750\u7262\u4e86\u3002\u6781\u9650\u6a21\u5f0f\u5c31\u6210\u4e86\u5982\u4f55\u8ba9\u81ea\u5df1\u624b\u4e0a\u4e00\u76f4\u6709\u4e0d\u6b7b\u56fe\u817e\u7684\u4e00\u822c\u6a21\u5f0f\u3002'],
    },
    {
      term: '\u4eca\u5929\u88ab\u6253\u4e86\u6ca1\u6709',
      family: 'attack',
      meaning: 'over-specific teasing question',
      evidenceCount: 1,
      evidenceSamples: ['\u5144\u5f1f\u8dd1\u7740\u53d1\u5c55\u4e1a\u52a1\u6765\u5566\uff0c\u4eca\u5929\u88ab\u6253\u4e86\u6ca1\u6709[doge]'],
    },
    {
      term: '\u7ea0\u6b63\u54e5',
      family: 'attack',
      meaning: 'label for someone who constantly corrects others',
      evidenceCount: 1,
      evidenceSamples: ['\u7b11\u70b9\u89e3\u6790\uff1a\u7ea0\u6b63\u54e5\u4e0d\u77e5\u9053\u5f17\u5170\u80af\u65af\u5766\u539f\u8457\u88ab\u9020\u51fa\u6765\u7684\u4ece\u672a\u53eb\u602a\u7269'],
    },
    {
      term: '\u4f60\u7684\u8bf4\u6cd5\u592a\u7edd\u5bf9\u4e86',
      family: 'attack',
      meaning: 'calls out absolutist wording',
      evidenceCount: 1,
      evidenceSamples: ['\u4f60\u7684\u8bf4\u6cd5\u592a\u7edd\u5bf9\u4e86\uff0c\u4f60\u5e94\u8be5\u8bf4\u201c\u5927\u90e8\u5206\u201d[doge_\u91d1\u7b8d]'],
    },
    {
      term: '\u6293\u5230\u4e00\u4e2a\u8001\u5b9e\u4eba',
      family: 'attack',
      meaning: 'mocks a naive reply target',
      evidenceCount: 1,
      evidenceSamples: ['\u6293\u5230\u4e00\u4e2a\u8001\u5b9e\u4eba\u5927\u5bb6\u5feb\u6765\u6b3a\u8d1f\u4ed6'],
    },
  ]);

  assert.deepEqual(entries.map((entry) => [entry.term, entry.evidenceSamples]), [
    ['\u7ea0\u6b63\u54e5', ['\u7b11\u70b9\u89e3\u6790\uff1a\u7ea0\u6b63\u54e5\u4e0d\u77e5\u9053\u5f17\u5170\u80af\u65af\u5766\u539f\u8457\u88ab\u9020\u51fa\u6765\u7684\u4ece\u672a\u53eb\u602a\u7269']],
    ['\u4f60\u7684\u8bf4\u6cd5\u592a\u7edd\u5bf9\u4e86', ['\u4f60\u7684\u8bf4\u6cd5\u592a\u7edd\u5bf9\u4e86\uff0c\u4f60\u5e94\u8be5\u8bf4\u201c\u5927\u90e8\u5206\u201d[doge_\u91d1\u7b8d]']],
    ['\u6293\u5230\u4e00\u4e2a\u8001\u5b9e\u4eba', ['\u6293\u5230\u4e00\u4e2a\u8001\u5b9e\u4eba\u5927\u5bb6\u5feb\u6765\u6b3a\u8d1f\u4ed6']],
  ]);
});
...
test('mergeEntriesIntoDictionary counts duplicate source labels for the same comment once', async () => {
  ...
  const dictionaryPath = join(dir, 'dictionary.json');
  try {
    const sameComment = '\u5ddd\u666e\u5fc3\u91cc\u6ca1\u70b9b\u6570\u561b\uff0c\u81ea\u5df1\u6cbb\u4e0d\u4e86\u5c31\u602a\u6e38\u620f';
    await mergeEntriesIntoDictionary(
      [
        {
          term: '\u5fc3\u91cc\u6ca1\u70b9b\u6570',
    ...
    const dictionary = await mergeEntriesIntoDictionary([], { dictionaryPath });
    const entry = dictionary.entries.find((item) => item.term === '\u5fc3\u91cc\u6ca1\u70b9b\u6570');
    assert.equal(entry.evidenceCount, 1);
...
test('mergeEntriesIntoDictionary keeps source metadata for distinct retained samples', async () => {
  const dir = await mkdtemp(join(tmpdir(), 'bili-merge-distinct-sample-sources-'));
  const dictionaryPath = join(dir, 'dictionary.json');
  try {
    const oldSample = '\u770b\u5230\u4f60\u8fd9\u7ef7\u4e0d\u4f4f\u4e86';
    const freshSamples = [
      '\u8fd9\u4e00\u6bb5\u5f7b\u5e95\u7ef7\u4e0d\u4f4f\u4e86',
      '\u5b8c\u4e86\u771f\u7684\u5f7b\u5e95\u7ef7\u4e0d\u4f4f\u4e86',
      '\u7b11\u5230\u5f7b\u5e95\u7ef7\u4e0d\u4f4f\u4e86',
      ...
      [
        {
          term: '\u5f7b\u5e95\u7ef7\u4e0d\u4f4f\u4e86',
          family: 'absolutes',
          meaning: 'complete loss of composure',
          confidence: 0.8,
          evidenceCount: 8,
          evidenceSamples: [oldSample],
          evidenceSources: Array.from({ length: 8 }, (_item, index) => ({
            source: `batch-scrape-${index}`,
            uid: `old-${index}`,
            sample: oldSample,
          })),
        },
      ...
      [
        {
          ...
          meaning: 'complete loss of composure',
          confidence: 0.8,
          evidenceCount: freshSamples.length,
          evidenceSamples: freshSamples,
          evidenceSources: freshSamples.map((sample, index) => ({
            source: `Bilibili public direct comment probe: https://www.bilibili.com/video/BVfresh${index}/`,
            uid: `BVfresh${index}`,
            sample,
          })),
        },
    ...
    const entry = dictionary.entries.find((item) => item.term === '\u5f7b\u5e95\u7ef7\u4e0d\u4f4f\u4e86');
    for (const sample of freshSamples) {
      assert.equal(entry.evidenceSources.some((source) => source.sample === sample), true);
    }
  } finally {
    await rm(dir, { recursive: true, force: true });
  }
...
test('trainKeywordDictionary uses DeepSeek V4 to map exact source phrases to existing terms only', async () => {
  ...
  try {
    ...
    assert.equal(chatBodies[0].reasoning_effort, undefined);
...
test('trains dictionary through DeepSeek V4 chat output and persists learned terms', async () => {
  ...
  try {
    ...
    assert.equal(seen.find((call) => call.body?.model)?.body.reasoning_effort, undefined);
    assert.equal(seen.find((call) => call.body?.model)?.body.thinking, undefined);
  } finally {
    await rm(dir, { recursive: true, force: true });
  }
});
...
test('retries DeepSeek keyword generation when JSON mode returns empty content', async () => {
  ...
  try {
    ...
    assert.equal(chatBodies[1].reasoning_effort, undefined);
