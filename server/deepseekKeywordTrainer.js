...
function isAmbiguousBenignEvidenceSample(term, family, sample) {
  ...
  if (term === '\u53ef\u4ee5\u8d34' && family === 'cooperation') {
    ...
    if ((hostileDareContext || genericDiscoveryContext) && !cooperativeSourceContext) return true;
  }
  ...
  if (term === '\u76ae\u5957' && family === 'cooperation') {
    const literalCostumeContext = /(?:\u5965\u7279|\u827e\u65af|\u96f7\u6b27|\u5965\u5144|\u5267\u60c5|\u6574\u5957|\u597d\u65b0|\u6253\u78e8).{0,18}\u76ae\u5957|\u76ae\u5957.{0,18}(?:\u5965\u7279|\u827e\u65af|\u96f7\u6b27|\u5965\u5144|\u5267\u60c5|\u6574\u5957|\u597d\u65b0|\u6253\u78e8)/u.test(cleanSample);
  ...
  if (term === '\u5982\u679c\u6709' && family === 'cooperation') {
    const genericWishContext = /(?:\u5982\u679c\u6709\u53ef\u80fd|\u5982\u679c\u6709\u4e00\u5929|\u5982\u679c\u6709\u673a\u4f1a)/u.test(cleanSample);
  ...
  if (term === '\u8c01\u61c2' && family === 'evasion') {
    ...
    const selfEmotionContext = /(?:\u8c01\u61c2\u554a|\u8c01\u61c2).{0,8}(?:\u6211\u54ed\u6b7b|\u6211\u7684\u7b11\u70b9|\u597d\u597d\u7b11|\u592a\u597d\u54ed|\u554a{2,})|(?:\u554a{2,}).{0,8}\u8c01\u61c2/u.test(cleanSample);
  ...
  if (term === '\u4fe1\u4ef0' && family === 'attack') {
    const literalBeliefContext = /(?:^\u4fe1\u4ef0$|\u4fe1\u4ef0(?:\u82b1\u795e|\u795e|\u5b97\u6559|\u4f5b|\u4e0a\u5e1d|\u4e3b|\u9644\u8eab)|(?:\u82b1\u795e|\u795e\u4f7f|\u5b97\u6559|\u9644\u8eab|\u795e\u8bdd|\u795e\u5316).*\u4fe1\u4ef0|\u6211\u4eec\u7684\u4fe1\u4ef0.*\u6211\u4eec\u81ea\u5df1)/u.test(cleanSample);
  ...
  if (['\u5c0f\u7c89\u7ea2', 'pink'].includes(term) && family === 'attack') {
    ...
    const literalColorContext = /\u7c89\u7ea2(?:\u8272|\u5154\u5b50).*(?:\u5973\u751f|\u8349\u8393|\u725b\u5976|\u53e3\u5473|\u8868\u60c5\u5305|\u6551\u547d)|(?:\u80f6\u56ca|\u8863\u670d|\u8272\u53f7|\u53e3\u7ea2|\u8868\u60c5\u5305).*\u7c89\u7ea2(?:\u8272|\u5154\u5b50)/u.test(cleanSample);
    const usernameOnlyContext = term === 'pink' && /^回复pink[a-z0-9]+/iu.test(cleanSample);
    const hostileLabelContext = /(?:\u5c0f\u7c89\u7ea2|\u7c89\u7ea2).*(?:\u8bdd\u672f|\u590d\u8bfb|\u5728\u6821\u5b66\u751f|\u8001\u5b9e|\u65e2\u5f97\u5229|\u53c8\u6765)|(?:\u4f60|\u4f60\u4eec|\u90fd\u662f).*(?:\u5c0f\u7c89\u7ea2|\u7c89\u7ea2)/u.test(cleanSample);
  ...
  if (term === '\u732a\u9f3b' && family === 'attack') {
    const literalObjectContext = /^(?:\u732a\u9f3b|\u732a\u9f3b\u5b50)$/u.test(cleanSample)
      || /(?:\u732a\u9f3b\u5b50.*(?:\u5e72\u4ec0\u4e48\u7528|\u6709\u4ec0\u4e48\u7528|\u7528\u5b83|\u4e0d\u7528\u5b83)|(?:\u5c31\u662f\u4e2a|\u662f\u4e2a|\u50cf\u4e2a|\u8fd9\u662f).{0,6}\u732a\u9f3b(?:\u5b50)?|(?:\u53cc\u7f1d\u5e72\u6d89|\u9053\u5177|\u6a21\u578b|\u88c5\u9970|\u5934\u5957|\u9762\u5177|\u9f3b\u5b50).{0,12}\u732a\u9f3b(?:\u5b50)?|\u732a\u9f3b(?:\u5b50)?.{0,12}(?:\u9053\u5177|\u6a21\u578b|\u88c5\u9970|\u5934\u5957|\u9762\u5177|\u9f3b\u5b50))/u.test(cleanSample);
    const directedCriticismContext = /(?:\u4f60|\u4f60\u4eec|\u4ed6|\u5979|\u8fd9\u4eba|\u522b).{0,8}\u732a\u9f3b|\u732a\u9f3b.{0,8}(?:\u4e00\u6837|\u786c\u62ac|\u5634\u786c|\u88c5|\u8822|\u7b28|\u5446|\u522b)/u.test(cleanSample);
  ...
  if (term === '\u90fd\u662f\u5bb6\u4eba' && family === 'cooperation') {
    const genericAddressContext = /(?:\u5bb6\u4eba\u4eec|\u5bb6\u4eba).*(?:\u6211\u542c|\u53d1\u70b9\u5f39\u5e55|\u53d1\u5f39\u5e55|\u6c42\u5f39\u5e55|\u6c42\u6c42|\u63a8\u8350|\u5e2e\u5fd9|\u770b\u770b|\u8c01\u77e5\u9053|\u5c5e\u5b9e|\u65e0\u8bed|\u5e26\u504f|\u9700\u8981|\u7eaa\u5ff5\u610f\u4e49|\u5b5d\u4e0d\u6d3b)|(?:\u5b5d\u4e0d\u6d3b.*\u5bb6\u4eba\u4eec|\u4e00\u53e3\u4e00\u4e2a\u5bb6\u4eba\u4eec|\u4e0d\u662f\u4f60\u4e00\u4e2a\u4eba.*\u4f60\u4e00\u5bb6\u4eba|\u5168\u5bb6\u4eba.*\u5408\u5f71|\u8ddf\u5bb6\u4eba.*\u5173\u7cfb|\u5bb6\u4eba\u7684\u671f\u5f85)/u.test(cleanSample);
  ...
  if (term === '\u4e0d\u5c2c' && family === 'cooperation') {
    ...
    return negatedAttackContext && !reassuranceContext;
  }
  ...
  if (term === '\u8c01\u61c2' && family === 'evasion') {
    const fandomEmpathyContext = /(?:\u6709\u8c01\u61c2|\u8c01\u61c2\u554a).*(?:\u6211\u54ed\u6b7b|\u6211\u7684\u7b11\u70b9|\u597d\u597d\u7b11|\u8dd1\u6b65|\u5f39\u5e55|\u66f4\u50cf|\u89d2\u5ea6|\u82e5\u9690\u82e5\u73b0|\u90d1\u723d|\u50cf\u4e86)|(?:\u554a{2,}).{0,8}\u8c01\u61c2/u.test(cleanSample);
    const evasionContext = /(?:\u522b\u53ea\u8bf4\u8c01\u61c2|\u8c01\u61c2.*(?:\u4e0d\u89e3\u91ca|\u61c2\u7684\u90fd\u61c2|\u8bc1\u636e\u8d34\u51fa\u6765|\u81ea\u5df1\u641c))/u.test(cleanSample);
  ...
  if (family === 'attack' && /(?:\u7ef7\u4e0d\u4f4f|\u6ca1\u7ef7\u4f4f)/u.test(cleanSample)) {
    ...
    const looseReactionContext = /^(?:[\p{Script=Han}]{0,4})?(?:\u6ca1\u7ef7\u4f4f|\u7ef7\u4e0d\u4f4f\u4e86?)$/u.test(cleanSample);
  ...
  if (term === '\u6807\u51c6\u7ed3\u5c40' && family === 'cooperation') {
    ...
    return (standaloneContext || sourceExplanationContext) && !summaryContext;
  }
  ...
  if (term === '\u524d\u9762\u8bf4\u91cd\u4e86' && family === 'correction') {
    const thirdPartyWrongContext = /(?:\u8bf4\u9519(?:\u4e86|\u8bdd\u4e86|\u8bdd).*(?:\u662f|\u6362\u4e2a\u53f7|\u4f60\u77e5\u9053\u4ed6\u662f\u8c01|\u82f1\u7f8e\u6218\u4e89|\u5766\u514b|\u4e0d\u662f|\u6ca1\u6709\u6279\u8bc4|\u6d3b\u6b7b\u4eba|\u540e\u679c)|\u4ee5\u4e3a\u6211\u8bf4\u9519\u8bdd\u4e86|\u4e00\u7d27\u5f20.*\u8bf4\u9519\u8bdd|\u4e2d\u95f4.*\u8bf4\u9519\u4e86|\u6709\u4e00\u53e5\u8bdd\u8bf4\u9519\u4e86|\u786e\u5b9e\u8bf4\u9519\u4e86|\u56de\u590d.*\u8bf4\u9519\u4e86|\u5982\u679c\u8bf4\u9519\u4e86|\u54ea\u8bf4\u9519\u4e86|\u8c01\u8bf4\u9519\u4e86|\u6ca1\u8bf4\u9519|\u6ca1\u6709\u4e00\u4e2a\u5b57\u8bf4\u9519|\u4e0d\u6562\u8bf4\u91cd\u4e86)/u.test(cleanSample);
  ...
  if (term === '\u795e\u795e' && family === 'attack') {
    const splitNameContext = /(?:\u539f\u795e[\u3001\uff0c,]\u795e\u5948|\u539f\u795e.*\u795e\u5948|shimeji|\u684c\u5ba0\u6846\u67b6|\u795e\u4e2d\u795e|\u6700\u5f3a\u7684\u4e00\u4e2a|\u795e\u795e\u53e8\u53e8|\u80a5\u795e\u795e|^\u795e{4,}$)/iu.test(cleanSample);
    ...
    return splitNameContext && (!attackContext || praiseNicknameContext);
  }
  if (term === '\u53ef\u4ee5\u8d34' && family === 'cooperation') {
    ...
    return genericPublishContext || shamingPublishContext || alreadyPublishedContext || (passivePublishContext && !requestToPostContext);
  }
  if (term === '\u5e72\u8d27up' && family === 'cooperation') {
    const negativeSubstanceContext = /(?:\u6ca1(?:\u5565|\u6709)?\u5e72\u8d27|\u4e0d\u662f\u5e72\u8d27|\u5e72\u8d27\u518d\u8bf4|\u662f\u4e0d\u662f\u5e72\u8d27\u518d\u8bf4|(?:\u8d28\u7591|\u66f2\u89e3).*\u5e72\u8d27|\u5e72\u8d27.*(?:\u6ca1(?:\u5565|\u6709)?|\u518d\u8bf4|\u8d28\u7591|\u66f2\u89e3))/u.test(cleanSample);
  ...
  if (term === '\u5f00\u5408' && family === 'attack') {
    const mechanicalContext = /(?:\u81ea\u52a8\u5f00\u5408|\u5f00\u5408(?:\u95e8|\u673a\u6784|\u89d2\u5ea6|\u88c5\u7f6e)|(?:\u95e8|\u673a\u6784|\u88c5\u7f6e).*\u5f00\u5408)/u.test(cleanSample);
  ...
  if (term === '\u53d1\u56fe' && family === 'evidence') {
    ...
    return existingImageReferenceContext && !requestImageContext;
  }
  if (term === '\u798f\u745e\u63a7' && family === 'cooperation') {
    ...
    return antiFurryContext && !furryFanContext;
  }
  ...
  if (term === '\u4f60\u4eec\u61c2\u5427' && family === 'evasion') {
    ...
    return insultContext && !hintContext;
  }
