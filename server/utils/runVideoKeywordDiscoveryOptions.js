...
import { DEFAULT_HARVEST_STATE_PATH } from '../services/keywordHarvest.js';
...
export function buildVideoKeywordDiscoveryOptions({
  ...
  return {
    ...
    lockPath: env.BILIBILI_HARVEST_LOCK_PATH || join(process.cwd(), 'server', 'data', '.keyword-harvest.lock'),
