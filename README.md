...
| Metric | Value |
|---|---:|
| Comments / replies | 25,636 |
| Danmaku | 152,175 |
| Keyword terms analyzed | 1,579 |
...
| 指标 / Metric | 值 / Value |
|---|---|
| 词典术语数 / Dictionary Terms | 1579 |
| 每条术语目标证据数 / Target Evidence per Term | 3 |
| 覆盖率 / Coverage Ratio | **97.09%** |
| 弱证据术语（低于目标）/ Weak Terms | 46 |
| 零证据术语 / Zero-Evidence Terms | 0 |
| 证据缺口 / Evidence Deficit | 86 |
| 有来源证据术语 / Source-Backed Terms | 1579 |
